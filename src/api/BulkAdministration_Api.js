...
/**
* BulkAdministration_ service.
* @module api/BulkAdministration_Api
* @version v1
*/
export default class BulkAdministration_Api {

    /**
    * Constructs a new BulkAdministration_Api. 
    * @alias module:api/BulkAdministration_Api
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the bulkCount operation.
     * @callback module:api/BulkAdministration_Api~bulkCountCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CountBulkResponse} data The data returned by the service call.
     ...
     * @param {module:api/BulkAdministration_Api~bulkCountCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CountBulkResponse}
     */
    bulkCount(authorization, callback) {
      let postBody = null;

      // verify the required parameter 'authorization' is set
      if (authorization === undefined || authorization === null) {
        throw new Error("Missing the required parameter 'authorization' when calling bulkCount");
      }
      ...
      let returnType = CountBulkResponse;
    ...
    /**
     * Callback function to receive the result of the bulkCountbyRequestId operation.
     * @callback module:api/BulkAdministration_Api~bulkCountbyRequestIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CountBulkResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/BulkAdministration_Api~bulkCountbyRequestIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CountBulkResponse}
     */
    bulkCountbyRequestId(authorization, requestId, callback) {
      let postBody = null;

      // verify the required parameter 'authorization' is set
      if (authorization === undefined || authorization === null) {
        throw new Error("Missing the required parameter 'authorization' when calling bulkCountbyRequestId");
      }

      // verify the required parameter 'requestId' is set
      if (requestId === undefined || requestId === null) {
        throw new Error("Missing the required parameter 'requestId' when calling bulkCountbyRequestId");
      }
     ...
     * @callback module:api/BulkAdministration_Api~bulkDeleteCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DeleteBulkResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} authorization Bearer access_token
     * @param {module:model/DeleteBulkRequest} body 
     * @param {module:api/BulkAdministration_Api~bulkDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DeleteBulkResponse}
     */
    bulkDelete(authorization, body, callback) {
      let postBody = body;

      // verify the required parameter 'authorization' is set
      if (authorization === undefined || authorization === null) {
        throw new Error("Missing the required parameter 'authorization' when calling bulkDelete");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling bulkDelete");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = DeleteBulkResponse;
    ...
    /**
     * Callback function to receive the result of the bulkDeletebyRequestId operation.
     * @callback module:api/BulkAdministration_Api~bulkDeletebyRequestIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DeleteBulkResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} authorization Bearer access_token
     * @param {Number} requestId RequestId returned due to timeout
     * @param {module:api/BulkAdministration_Api~bulkDeletebyRequestIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DeleteBulkResponse}
     */
    bulkDeletebyRequestId(authorization, requestId, callback) {
      let postBody = null;

      // verify the required parameter 'authorization' is set
      if (authorization === undefined || authorization === null) {
        throw new Error("Missing the required parameter 'authorization' when calling bulkDeletebyRequestId");
      }

      // verify the required parameter 'requestId' is set
      if (requestId === undefined || requestId === null) {
        throw new Error("Missing the required parameter 'requestId' when calling bulkDeletebyRequestId");
      }
    ...
    /**
     * Callback function to receive the result of the bulkList operation.
     * @callback module:api/BulkAdministration_Api~bulkListCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ListBulkResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} authorization Bearer access_token
     * @param {module:api/BulkAdministration_Api~bulkListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ListBulkResponse}
     */
    bulkList(authorization, callback) {
      let postBody = null;

      // verify the required parameter 'authorization' is set
      if (authorization === undefined || authorization === null) {
        throw new Error("Missing the required parameter 'authorization' when calling bulkList");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = ListBulkResponse;
    ...
    /**
     * Callback function to receive the result of the bulkListSyncTimeout operation.
     * @callback module:api/BulkAdministration_Api~bulkListSyncTimeoutCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ListBulkResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} authorization Bearer access_token
     * @param {Number} requestId RequestId returned due to timeout
     * @param {module:api/BulkAdministration_Api~bulkListSyncTimeoutCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ListBulkResponse}
     */
    bulkListSyncTimeout(authorization, requestId, callback) {
      let postBody = null;

      // verify the required parameter 'authorization' is set
      if (authorization === undefined || authorization === null) {
        throw new Error("Missing the required parameter 'authorization' when calling bulkListSyncTimeout");
      }

      // verify the required parameter 'requestId' is set
      if (requestId === undefined || requestId === null) {
        throw new Error("Missing the required parameter 'requestId' when calling bulkListSyncTimeout");
      }
