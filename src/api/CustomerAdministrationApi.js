...
/**
* CustomerAdministration service.
* @module api/CustomerAdministrationApi
* @version v1
*/
export default class CustomerAdministrationApi {

    /**
    * Constructs a new CustomerAdministrationApi. 
    * @alias module:api/CustomerAdministrationApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the customerUnlock operation.
     * @callback module:api/CustomerAdministrationApi~customerUnlockCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CustomerUnlockResponse} data The data returned by the service call.
     ...
     * @param {module:model/CustomerUnlockRequest} body 
     * @param {module:api/CustomerAdministrationApi~customerUnlockCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CustomerUnlockResponse}
     */
    customerUnlock(authorization, body, callback) {
      let postBody = body;

      // verify the required parameter 'authorization' is set
      if (authorization === undefined || authorization === null) {
        throw new Error("Missing the required parameter 'authorization' when calling customerUnlock");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling customerUnlock");
      }
      ...
      let returnType = CustomerUnlockResponse;
    ...
    /**
     * Callback function to receive the result of the customerUnlockByRequestId operation.
     * @callback module:api/CustomerAdministrationApi~customerUnlockByRequestIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CustomerUnlockResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/CustomerAdministrationApi~customerUnlockByRequestIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CustomerUnlockResponse}
     */
    customerUnlockByRequestId(authorization, requestId, callback) {
      let postBody = null;

      // verify the required parameter 'authorization' is set
      if (authorization === undefined || authorization === null) {
        throw new Error("Missing the required parameter 'authorization' when calling customerUnlockByRequestId");
      }

      // verify the required parameter 'requestId' is set
      if (requestId === undefined || requestId === null) {
        throw new Error("Missing the required parameter 'requestId' when calling customerUnlockByRequestId");
      }
