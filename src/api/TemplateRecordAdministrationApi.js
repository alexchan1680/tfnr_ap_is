...
/**
* TemplateRecordAdministration service.
* @module api/TemplateRecordAdministrationApi
* @version v1
*/
export default class TemplateRecordAdministrationApi {

    /**
    * Constructs a new TemplateRecordAdministrationApi. 
    * @alias module:api/TemplateRecordAdministrationApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the templateRecordList operation.
     * @callback module:api/TemplateRecordAdministrationApi~templateRecordListCallback
     ...
     * @param {String} tempEntRecId Entity ID for which the list of Template records will be returned
     * @param {Object} opts Optional parameters
     * @param {String} opts.startTempName Template Name 
     * @param {module:api/TemplateRecordAdministrationApi~templateRecordListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TemplateListResponse}
     */
    templateRecordList(authorization, tempEntRecId, opts, callback) {
      opts = opts || {};
      let postBody = null;

      // verify the required parameter 'authorization' is set
      if (authorization === undefined || authorization === null) {
        throw new Error("Missing the required parameter 'authorization' when calling templateRecordList");
      }

      // verify the required parameter 'tempEntRecId' is set
      if (tempEntRecId === undefined || tempEntRecId === null) {
        throw new Error("Missing the required parameter 'tempEntRecId' when calling templateRecordList");
      }
      ...
      let queryParams = {
        'tempEntRecId': tempEntRecId,
        'startTempName': opts['startTempName']
      };
      let headerParams = {
    ...
    /**
     * Callback function to receive the result of the templateRecordListbyRequestId operation.
     * @callback module:api/TemplateRecordAdministrationApi~templateRecordListbyRequestIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TemplateListResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/TemplateRecordAdministrationApi~templateRecordListbyRequestIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TemplateListResponse}
     */
    templateRecordListbyRequestId(authorization, requestId, callback) {
      let postBody = null;

      // verify the required parameter 'authorization' is set
      if (authorization === undefined || authorization === null) {
        throw new Error("Missing the required parameter 'authorization' when calling templateRecordListbyRequestId");
      }

      // verify the required parameter 'requestId' is set
      if (requestId === undefined || requestId === null) {
        throw new Error("Missing the required parameter 'requestId' when calling templateRecordListbyRequestId");
      }
      ...
      return this.apiClient.callApi(
        '/cus/template/list/{requestId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the templateRecordQuery operation.
     * @callback module:api/TemplateRecordAdministrationApi~templateRecordQueryCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TemplateRecordQueryResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/TemplateRecordAdministrationApi~templateRecordQueryCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TemplateRecordQueryResponse}
     */
    templateRecordQuery(authorization, tmplName, opts, callback) {
      opts = opts || {};
      let postBody = null;

      // verify the required parameter 'authorization' is set
      if (authorization === undefined || authorization === null) {
        throw new Error("Missing the required parameter 'authorization' when calling templateRecordQuery");
      }

      // verify the required parameter 'tmplName' is set
      if (tmplName === undefined || tmplName === null) {
        throw new Error("Missing the required parameter 'tmplName' when calling templateRecordQuery");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = TemplateRecordQueryResponse;

      return this.apiClient.callApi(
        '/cus/template/query', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
