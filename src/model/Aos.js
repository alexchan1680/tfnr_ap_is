...
/**
* The Aos model module.
* @module model/Aos
* @version v1
*/
export default class Aos {
    /**
    * Constructs a new <code>Aos</code>.
    * @alias module:model/Aos
    * @class
    */
    ...
    /**
    * Constructs a <code>Aos</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/Aos} obj Optional instance to populate.
    * @return {module:model/Aos} The populated <code>Aos</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('aosLbl')) {
                obj['aosLbl'] = ApiClient.convertToType(data['aosLbl'], ['String']);
            }
            if (data.hasOwnProperty('aosAC')) {
                obj['aosAC'] = ApiClient.convertToType(data['aosAC'], ['String']);
            }
            if (data.hasOwnProperty('aosLATA')) {
                obj['aosLATA'] = ApiClient.convertToType(data['aosLATA'], ['String']);
            }
            if (data.hasOwnProperty('aosNet')) {
                obj['aosNet'] = ApiClient.convertToType(data['aosNet'], ['String']);
            }
            if (data.hasOwnProperty('aosState')) {
                obj['aosState'] = ApiClient.convertToType(data['aosState'], [States]);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {Array.<String>} aosLbl
    */
    aosLbl = undefined;
    /**
    * @member {Array.<String>} aosAC
    */
    aosAC = undefined;
    /**
    * @member {Array.<String>} aosLATA
    */
    aosLATA = undefined;
    /**
    * @member {Array.<String>} aosNet
    */
    aosNet = undefined;
    /**
    * Areas of Service - State. Each state entry must be 2 bytes alphabetic, must be valid state codes. No embedded blanks are allowed. 
    * @member {Array.<module:model/States>} aosState
    */
    aosState = undefined;
