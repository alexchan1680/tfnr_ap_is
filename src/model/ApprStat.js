...
export default class ApprStat {
    ...
    /**
    * Returns a <code>ApprStat</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ApprStat} The enum <code>ApprStat</code> value.
    */
