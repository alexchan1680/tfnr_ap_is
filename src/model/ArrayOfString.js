...
/**
* The ArrayOfString model module.
* @module model/ArrayOfString
* @version v1
*/
export default class ArrayOfString {
    /**
    * Constructs a new <code>ArrayOfString</code>.
    * @alias module:model/ArrayOfString
    * @class
    */
    ...
    /**
    * Constructs a <code>ArrayOfString</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ArrayOfString} obj Optional instance to populate.
    * @return {module:model/ArrayOfString} The populated <code>ArrayOfString</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ArrayOfString();
