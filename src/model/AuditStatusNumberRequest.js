...
/**
* The AuditStatusNumberRequest model module.
* @module model/AuditStatusNumberRequest
* @version v1
*/
export default class AuditStatusNumberRequest {
    /**
    * Constructs a new <code>AuditStatusNumberRequest</code>.
    * @alias module:model/AuditStatusNumberRequest
    * @class
    * @param recNum {String} 
    * @param critInd {module:model/CritInd} 
    */

    constructor(recNum, critInd) {
        

        
        

        this['recNum'] = recNum;this['critInd'] = critInd;

        
    }

    /**
    * Constructs a <code>AuditStatusNumberRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AuditStatusNumberRequest} obj Optional instance to populate.
    * @return {module:model/AuditStatusNumberRequest} The populated <code>AuditStatusNumberRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AuditStatusNumberRequest();
            ...
            if (data.hasOwnProperty('critInd')) {
                obj['critInd'] = CritInd.constructFromObject(data['critInd']);
            }
    ...
    */
    effDtTm = undefined;
    /**
    * @member {module:model/CritInd} critInd
    */
    critInd = undefined;
    /**
