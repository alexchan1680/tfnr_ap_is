...
import RecStat from './RecStat';
import ScpRecs from './ScpRecs';
...
/**
* The AuditStatusNumberResponse model module.
* @module model/AuditStatusNumberResponse
* @version v1
*/
export default class AuditStatusNumberResponse {
    /**
    * Constructs a new <code>AuditStatusNumberResponse</code>.
    * @alias module:model/AuditStatusNumberResponse
    * @class
    * @param recNum {String} 
    */
    ...
    /**
    * Constructs a <code>AuditStatusNumberResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AuditStatusNumberResponse} obj Optional instance to populate.
    * @return {module:model/AuditStatusNumberResponse} The populated <code>AuditStatusNumberResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AuditStatusNumberResponse();

            
            
            

            if (data.hasOwnProperty('recNum')) {
                obj['recNum'] = ApiClient.convertToType(data['recNum'], 'String');
            }
            if (data.hasOwnProperty('recStat')) {
                obj['recStat'] = ApiClient.convertToType(data['recStat'], [RecStat]);
            }
            if (data.hasOwnProperty('scpRecs')) {
                obj['scpRecs'] = ApiClient.convertToType(data['scpRecs'], [ScpRecs]);
            }
    ...
    /**
    * @member {String} recNum
    */
    recNum = undefined;
    /**
    * @member {Array.<module:model/RecStat>} recStat
    */
    recStat = undefined;
    /**
    * @member {Array.<module:model/ScpRecs>} scpRecs
    */
    scpRecs = undefined;
    /**
