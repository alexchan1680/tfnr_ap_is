...
/**
* The BlkLst model module.
* @module model/BlkLst
* @version v1
*/
export default class BlkLst {
    /**
    * Constructs a new <code>BlkLst</code>.
    * @alias module:model/BlkLst
    * @class
    */
    ...
    /**
    * Constructs a <code>BlkLst</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/BlkLst} obj Optional instance to populate.
    * @return {module:model/BlkLst} The populated <code>BlkLst</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('crDt')) {
                obj['crDt'] = ApiClient.convertToType(data['crDt'], 'String');
            }
            if (data.hasOwnProperty('cmplDt')) {
                obj['cmplDt'] = ApiClient.convertToType(data['cmplDt'], 'String');
            }
            if (data.hasOwnProperty('usrId')) {
                obj['usrId'] = ApiClient.convertToType(data['usrId'], 'String');
            }
            if (data.hasOwnProperty('reqType')) {
                obj['reqType'] = ReqType.constructFromObject(data['reqType']);
            }
            if (data.hasOwnProperty('blkId')) {
                obj['blkId'] = ApiClient.convertToType(data['blkId'], 'String');
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = ReqStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
    ...
    */
    usrId = undefined;
    /**
    * @member {module:model/ReqType} reqType
    */
    reqType = undefined;
    /**
    * @member {String} blkId
    */
    blkId = undefined;
    /**
    * @member {module:model/ReqStatus} status
    */
    status = undefined;
