...
/**
* The BlkResp model module.
* @module model/BlkResp
* @version v1
*/
export default class BlkResp {
    /**
    * Constructs a new <code>BlkResp</code>.
    * @alias module:model/BlkResp
    * @class
    * @param tfNum {String} 
    * @param status {module:model/Status} 
    */

    constructor(tfNum, status) {
        

        
        

        this['tfNum'] = tfNum;this['status'] = status;

        
    }

    /**
    * Constructs a <code>BlkResp</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/BlkResp} obj Optional instance to populate.
    * @return {module:model/BlkResp} The populated <code>BlkResp</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('tfNum')) {
                obj['tfNum'] = ApiClient.convertToType(data['tfNum'], 'String');
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = Status.constructFromObject(data['status']);
            }
            if (data.hasOwnProperty('timeOutResp')) {
                obj['timeOutResp'] = ErrList.constructFromObject(data['timeOutResp']);
            }
        }
        return obj;
    }
    ...
    */
    status = undefined;
    /**
    * @member {module:model/ErrList} timeOutResp
    */
    timeOutResp = undefined;
