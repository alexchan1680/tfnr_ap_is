...
export default class BoolYN {
    ...
    /**
    * Returns a <code>BoolYN</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/BoolYN} The enum <code>BoolYN</code> value.
    */
