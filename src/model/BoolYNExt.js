...
/**
* Enum class BoolYNExt.
* @enum {}
* @readonly
*/
export default class BoolYNExt {
    ...
    /**
    * Returns a <code>BoolYNExt</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/BoolYNExt} The enum <code>BoolYNExt</code> value.
    */
