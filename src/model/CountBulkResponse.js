...
/**
* The CountBulkResponse model module.
* @module model/CountBulkResponse
* @version v1
*/
export default class CountBulkResponse {
    /**
    * Constructs a new <code>CountBulkResponse</code>.
    * @alias module:model/CountBulkResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>CountBulkResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CountBulkResponse} obj Optional instance to populate.
    * @return {module:model/CountBulkResponse} The populated <code>CountBulkResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CountBulkResponse();

            
            
            

            if (data.hasOwnProperty('blkReqCount')) {
                obj['blkReqCount'] = ApiClient.convertToType(data['blkReqCount'], 'Number');
            }
    ...
    /**
    * The count value represents the number of Bulk Requests that are not pending or Queued and not yet retrieved at least once
    * @member {Number} blkReqCount
    */
    blkReqCount = undefined;
    /**
    * A unique value to represent the submitted response.
