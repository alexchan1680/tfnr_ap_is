...
/**
* The CprSectName model module.
* @module model/CprSectName
* @version v1
*/
export default class CprSectName {
    /**
    * Constructs a new <code>CprSectName</code>.
    * @alias module:model/CprSectName
    * @class
    * @param name {String} 
    * @param nodeSeq {Array.<String>} 
    * @param nodes {Array.<module:model/Nodes>} CPR Section Name - contains Nodes
    */

    constructor(name, nodeSeq, nodes) {
        

        
        

        this['name'] = name;this['nodeSeq'] = nodeSeq;this['nodes'] = nodes;

        
    }

    /**
    * Constructs a <code>CprSectName</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CprSectName} obj Optional instance to populate.
    * @return {module:model/CprSectName} The populated <code>CprSectName</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CprSectName();
            ...
            if (data.hasOwnProperty('nodeSeq')) {
                obj['nodeSeq'] = ApiClient.convertToType(data['nodeSeq'], ['String']);
            }
            if (data.hasOwnProperty('nodes')) {
                obj['nodes'] = ApiClient.convertToType(data['nodes'], [Nodes]);
            }
        }
        return obj;
    }
    ...
    */
    name = undefined;
    /**
    * @member {Array.<String>} nodeSeq
    */
    nodeSeq = undefined;
    /**
    * CPR Section Name - contains Nodes
    * @member {Array.<module:model/Nodes>} nodes
    */
    nodes = undefined;
