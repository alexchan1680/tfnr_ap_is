...
export default class CritInd {
    ...
    /**
    * Returns a <code>CritInd</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CritInd} The enum <code>CritInd</code> value.
    */
