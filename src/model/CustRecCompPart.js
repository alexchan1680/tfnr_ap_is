...
/**
* Enum class CustRecCompPart.
* @enum {}
* @readonly
*/
export default class CustRecCompPart {
        ...
        /**
         * value: "Copied CAD only"
         * @const
         */
        Copied CAD only = "Copied CAD only";

    
        /**
         * value: "Copied CAD, LAD"
         * @const
         */
        Copied CAD, LAD = "Copied CAD, LAD";

    
        /**
         * value: "Copied CAD, CPR"
         * @const
         */
        Copied CAD, CPR = "Copied CAD, CPR";

    
        /**
         * value: "Copied CAD, LAD, CPR"
         * @const
         */
        Copied CAD, LAD, CPR = "Copied CAD, LAD, CPR";

    
        /**
         * value: "Copied TAD only"
         * @const
         */
        Copied TAD only = "Copied TAD only";

    
        /**
         * value: "Copied TAD, LAD"
         * @const
         */
        Copied TAD, LAD = "Copied TAD, LAD";

    
        /**
         * value: "Copied TAD, CPR"
         * @const
         */
        Copied TAD, CPR = "Copied TAD, CPR";

    
        /**
         * value: "Copied TAD, LAD, CPR"
         * @const
         */
        Copied TAD, LAD, CPR = "Copied TAD, LAD, CPR";
        ...
        /**
         * value: "Copied PAD only"
         * @const
         */
        Copied PAD only = "Copied PAD only";
         ...
         * @const
         */
        TAD, LAD, CPR = "TAD, LAD, CPR";

    

    /**
    * Returns a <code>CustRecCompPart</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CustRecCompPart} The enum <code>CustRecCompPart</code> value.
    */
