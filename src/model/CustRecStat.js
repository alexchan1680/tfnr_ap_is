...
/**
* Enum class CustRecStat.
* @enum {}
* @readonly
*/
export default class CustRecStat {
    ...
    /**
    * Returns a <code>CustRecStat</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CustRecStat} The enum <code>CustRecStat</code> value.
    */
