...
/**
* The CustomerRecordQueryResponse model module.
* @module model/CustomerRecordQueryResponse
* @version v1
*/
export default class CustomerRecordQueryResponse {
    /**
    * Constructs a new <code>CustomerRecordQueryResponse</code>.
    * @alias module:model/CustomerRecordQueryResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>CustomerRecordQueryResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CustomerRecordQueryResponse} obj Optional instance to populate.
    * @return {module:model/CustomerRecordQueryResponse} The populated <code>CustomerRecordQueryResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomerRecordQueryResponse();
