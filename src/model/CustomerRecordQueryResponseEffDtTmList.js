...
/**
* The CustomerRecordQueryResponseEffDtTmList model module.
* @module model/CustomerRecordQueryResponseEffDtTmList
* @version v1
*/
export default class CustomerRecordQueryResponseEffDtTmList {
    /**
    * Constructs a new <code>CustomerRecordQueryResponseEffDtTmList</code>.
    * @alias module:model/CustomerRecordQueryResponseEffDtTmList
    * @class
    */
    ...
    /**
    * Constructs a <code>CustomerRecordQueryResponseEffDtTmList</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CustomerRecordQueryResponseEffDtTmList} obj Optional instance to populate.
    * @return {module:model/CustomerRecordQueryResponseEffDtTmList} The populated <code>CustomerRecordQueryResponseEffDtTmList</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomerRecordQueryResponseEffDtTmList();
            ...
            if (data.hasOwnProperty('custRecOrderType')) {
                obj['custRecOrderType'] = ApiClient.convertToType(data['custRecOrderType'], 'String');
            }
        }
        return obj;
    }
    ...
    */
    ...
    /**
    * @member {String} custRecOrderType
    */
    custRecOrderType = undefined;
