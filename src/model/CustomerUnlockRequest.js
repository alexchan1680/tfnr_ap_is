...
/**
* The CustomerUnlockRequest model module.
* @module model/CustomerUnlockRequest
* @version v1
*/
export default class CustomerUnlockRequest {
    /**
    * Constructs a new <code>CustomerUnlockRequest</code>.
    * @alias module:model/CustomerUnlockRequest
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>CustomerUnlockRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CustomerUnlockRequest} obj Optional instance to populate.
    * @return {module:model/CustomerUnlockRequest} The populated <code>CustomerUnlockRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomerUnlockRequest();
            ...
            if (data.hasOwnProperty('costCauserFlag')) {
                obj['costCauserFlag'] = BoolYN.constructFromObject(data['costCauserFlag']);
            }
    ...
    */
    num = undefined;
    /**
    * @member {module:model/BoolYN} costCauserFlag
    */
    costCauserFlag = undefined;
    /**
