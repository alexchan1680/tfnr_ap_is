...
/**
* The CustomerUnlockResponse model module.
* @module model/CustomerUnlockResponse
* @version v1
*/
export default class CustomerUnlockResponse {
    /**
    * Constructs a new <code>CustomerUnlockResponse</code>.
    * @alias module:model/CustomerUnlockResponse
    * @class
    * @param num {String} Dialed number of the record
    * @param effDtTm {String} Effective date and time of the records
    */

    constructor(num, effDtTm) {
        

        
        

        this['num'] = num;this['effDtTm'] = effDtTm;

        
    }

    /**
    * Constructs a <code>CustomerUnlockResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CustomerUnlockResponse} obj Optional instance to populate.
    * @return {module:model/CustomerUnlockResponse} The populated <code>CustomerUnlockResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomerUnlockResponse();
