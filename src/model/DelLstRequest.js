...
/**
* The DelLstRequest model module.
* @module model/DelLstRequest
* @version v1
*/
export default class DelLstRequest {
    /**
    * Constructs a new <code>DelLstRequest</code>.
    * @alias module:model/DelLstRequest
    * @class
    * @param reqId {String} Id to retrieve the status, and results of the earlier request.
    */
    ...
    /**
    * Constructs a <code>DelLstRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DelLstRequest} obj Optional instance to populate.
    * @return {module:model/DelLstRequest} The populated <code>DelLstRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DelLstRequest();
            ...
            if (data.hasOwnProperty('reqStatus')) {
                obj['reqStatus'] = ReqStatus.constructFromObject(data['reqStatus']);
            }
        }
        return obj;
    }
    ...
    /**
    * Id to retrieve the status, and results of the earlier request.
    * @member {String} reqId
    */
    reqId = undefined;
    /**
    * @member {module:model/ReqStatus} reqStatus
    */
    reqStatus = undefined;
