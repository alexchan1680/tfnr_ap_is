...
/**
* The DelLstResponse model module.
* @module model/DelLstResponse
* @version v1
*/
export default class DelLstResponse {
    /**
    * Constructs a new <code>DelLstResponse</code>.
    * @alias module:model/DelLstResponse
    * @class
    * @param requestId {String} Id to identify this Bulk operation request.
    * @param delStatus {module:model/ErrList} 
    */

    constructor(requestId, delStatus) {
        

        
        

        this['requestId'] = requestId;this['delStatus'] = delStatus;

        
    }

    /**
    * Constructs a <code>DelLstResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DelLstResponse} obj Optional instance to populate.
    * @return {module:model/DelLstResponse} The populated <code>DelLstResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DelLstResponse();
            ...
            if (data.hasOwnProperty('delStatus')) {
                obj['delStatus'] = ErrList.constructFromObject(data['delStatus']);
            }
        }
        return obj;
    }
    ...
    */
    blkId = undefined;
    /**
    * Id to identify this Bulk operation request.
    * @member {String} requestId
    */
    requestId = undefined;
    /**
    * @member {module:model/ErrList} delStatus
    */
    delStatus = undefined;
