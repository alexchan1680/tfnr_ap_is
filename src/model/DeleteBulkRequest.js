...
import DelLstRequest from './DelLstRequest';
...
/**
* The DeleteBulkRequest model module.
* @module model/DeleteBulkRequest
* @version v1
*/
export default class DeleteBulkRequest {
    /**
    * Constructs a new <code>DeleteBulkRequest</code>.
    * @alias module:model/DeleteBulkRequest
    * @class
    * @param delLst {Array.<module:model/DelLstRequest>} 
    */
    ...
    /**
    * Constructs a <code>DeleteBulkRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DeleteBulkRequest} obj Optional instance to populate.
    * @return {module:model/DeleteBulkRequest} The populated <code>DeleteBulkRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteBulkRequest();
            ...
            if (data.hasOwnProperty('delLst')) {
                obj['delLst'] = ApiClient.convertToType(data['delLst'], [DelLstRequest]);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {Array.<module:model/DelLstRequest>} delLst
    */
    delLst = undefined;
