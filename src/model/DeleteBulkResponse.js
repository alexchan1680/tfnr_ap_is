...
import DelLstResponse from './DelLstResponse';
...
/**
* The DeleteBulkResponse model module.
* @module model/DeleteBulkResponse
* @version v1
*/
export default class DeleteBulkResponse {
    /**
    * Constructs a new <code>DeleteBulkResponse</code>.
    * @alias module:model/DeleteBulkResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>DeleteBulkResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DeleteBulkResponse} obj Optional instance to populate.
    * @return {module:model/DeleteBulkResponse} The populated <code>DeleteBulkResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteBulkResponse();

            
            
            

            if (data.hasOwnProperty('delLst')) {
                obj['delLst'] = ApiClient.convertToType(data['delLst'], [DelLstResponse]);
            }
    ...
    /**
    * @member {Array.<module:model/DelLstResponse>} delLst
    */
    delLst = undefined;
    /**
