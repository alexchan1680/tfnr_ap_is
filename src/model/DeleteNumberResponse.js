...
/**
* The DeleteNumberResponse model module.
* @module model/DeleteNumberResponse
* @version v1
*/
export default class DeleteNumberResponse {
    /**
    * Constructs a new <code>DeleteNumberResponse</code>.
    * @alias module:model/DeleteNumberResponse
    * @class
    * @param recNum {String} 
    */
    ...
    /**
    * Constructs a <code>DeleteNumberResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DeleteNumberResponse} obj Optional instance to populate.
    * @return {module:model/DeleteNumberResponse} The populated <code>DeleteNumberResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteNumberResponse();
