...
/**
* The DeletePointerRequest model module.
* @module model/DeletePointerRequest
* @version v1
*/
export default class DeletePointerRequest {
    /**
    * Constructs a new <code>DeletePointerRequest</code>.
    * @alias module:model/DeletePointerRequest
    * @class
    ...
    */
    ...
    constructor(num, effDtTm, reqSntFrom) {
        

        
        

        this['num'] = num;this['effDtTm'] = effDtTm;this['reqSntFrom'] = reqSntFrom;

        
    }

    /**
    * Constructs a <code>DeletePointerRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DeletePointerRequest} obj Optional instance to populate.
    * @return {module:model/DeletePointerRequest} The populated <code>DeletePointerRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeletePointerRequest();
