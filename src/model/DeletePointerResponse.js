...
/**
* The DeletePointerResponse model module.
* @module model/DeletePointerResponse
* @version v1
*/
export default class DeletePointerResponse {
    /**
    * Constructs a new <code>DeletePointerResponse</code>.
    * @alias module:model/DeletePointerResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>DeletePointerResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DeletePointerResponse} obj Optional instance to populate.
    * @return {module:model/DeletePointerResponse} The populated <code>DeletePointerResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeletePointerResponse();
            ...
            if (data.hasOwnProperty('apprStat')) {
                obj['apprStat'] = ApiClient.convertToType(data['apprStat'], 'String');
            }
