...
/**
* The DestNums model module.
* @module model/DestNums
* @version v1
*/
export default class DestNums {
    /**
    * Constructs a new <code>DestNums</code>.
    * @alias module:model/DestNums
    * @class
    * @param destNum {String} 
    * @param numTermLine {Number} 
    */

    constructor(destNum, numTermLine) {
        

        
        

        this['destNum'] = destNum;this['numTermLine'] = numTermLine;

        
    }

    /**
    * Constructs a <code>DestNums</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DestNums} obj Optional instance to populate.
    * @return {module:model/DestNums} The populated <code>DestNums</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DestNums();

            
            
            

            if (data.hasOwnProperty('destNum')) {
                obj['destNum'] = ApiClient.convertToType(data['destNum'], 'String');
            }
            if (data.hasOwnProperty('numTermLine')) {
                obj['numTermLine'] = ApiClient.convertToType(data['numTermLine'], 'Number');
            }
            if (data.hasOwnProperty('forSrvOff')) {
                obj['forSrvOff'] = ApiClient.convertToType(data['forSrvOff'], 'String');
            }
            if (data.hasOwnProperty('localServOff')) {
                obj['localServOff'] = ApiClient.convertToType(data['localServOff'], 'String');
            }
        }
        return obj;
    }
    ...
    */
    ...
    /**
    * @member {String} forSrvOff
    */
    forSrvOff = undefined;
    /**
    * @member {String} localServOff
    */
    localServOff = undefined;
