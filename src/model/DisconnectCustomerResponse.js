...
/**
* The DisconnectCustomerResponse model module.
* @module model/DisconnectCustomerResponse
* @version v1
*/
export default class DisconnectCustomerResponse {
    /**
    * Constructs a new <code>DisconnectCustomerResponse</code>.
    * @alias module:model/DisconnectCustomerResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>DisconnectCustomerResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DisconnectCustomerResponse} obj Optional instance to populate.
    * @return {module:model/DisconnectCustomerResponse} The populated <code>DisconnectCustomerResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisconnectCustomerResponse();
            ...
            if (data.hasOwnProperty('custRecEntity')) {
                obj['custRecEntity'] = ApiClient.convertToType(data['custRecEntity'], 'String');
            }
    ...
    */
    ...
    /**
    * @member {String} custRecEntity
    */
    custRecEntity = undefined;
    /**
