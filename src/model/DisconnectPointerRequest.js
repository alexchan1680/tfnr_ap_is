...
/**
* The DisconnectPointerRequest model module.
* @module model/DisconnectPointerRequest
* @version v1
*/
export default class DisconnectPointerRequest {
    /**
    * Constructs a new <code>DisconnectPointerRequest</code>.
    * @alias module:model/DisconnectPointerRequest
    * @class
    ...
    */
    ...
    constructor(num, effDtTm, reqSntFrom, cmd, referral, endInterceptDt, hldIndFlag, destNums) {
        

        
        

        this['num'] = num;this['effDtTm'] = effDtTm;this['reqSntFrom'] = reqSntFrom;this['cmd'] = cmd;this['referral'] = referral;this['endInterceptDt'] = endInterceptDt;this['hldIndFlag'] = hldIndFlag;this['destNums'] = destNums;

        
    }

    /**
    * Constructs a <code>DisconnectPointerRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DisconnectPointerRequest} obj Optional instance to populate.
    * @return {module:model/DisconnectPointerRequest} The populated <code>DisconnectPointerRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisconnectPointerRequest();
