...
/**
* The DisconnectPointerResponse model module.
* @module model/DisconnectPointerResponse
* @version v1
*/
export default class DisconnectPointerResponse {
    /**
    * Constructs a new <code>DisconnectPointerResponse</code>.
    * @alias module:model/DisconnectPointerResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>DisconnectPointerResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DisconnectPointerResponse} obj Optional instance to populate.
    * @return {module:model/DisconnectPointerResponse} The populated <code>DisconnectPointerResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisconnectPointerResponse();
