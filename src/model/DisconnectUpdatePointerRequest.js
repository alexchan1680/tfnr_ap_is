...
/**
* The DisconnectUpdatePointerRequest model module.
* @module model/DisconnectUpdatePointerRequest
* @version v1
*/
export default class DisconnectUpdatePointerRequest {
    /**
    * Constructs a new <code>DisconnectUpdatePointerRequest</code>.
    * @alias module:model/DisconnectUpdatePointerRequest
    * @class
    * @param num {String} Dialed number of the record Format is npanxxxxxx. 10 character string.
    * @param srcEffDtTm {String} Effective date and time of the recordsISO 8601
    ...
    */
    ...
    constructor(num, srcEffDtTm, reqSntFrom, cmd, referral, endInterceptDt, hldIndFlag, destNums) {
        

        
        

        this['num'] = num;this['srcEffDtTm'] = srcEffDtTm;this['reqSntFrom'] = reqSntFrom;this['cmd'] = cmd;this['referral'] = referral;this['endInterceptDt'] = endInterceptDt;this['hldIndFlag'] = hldIndFlag;this['destNums'] = destNums;

        
    }

    /**
    * Constructs a <code>DisconnectUpdatePointerRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DisconnectUpdatePointerRequest} obj Optional instance to populate.
    * @return {module:model/DisconnectUpdatePointerRequest} The populated <code>DisconnectUpdatePointerRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisconnectUpdatePointerRequest();
    ...
    */
    ...
    /**
    * This is a 15 byte text field (starts with *) containing the Template 
    ...
    */
    cmd = undefined;
    /**
    * Priority of the Update. optional 1 byte identifier.H -High.The value �H� is the only allowed value at this time.When priority=H, then effective date of customer record must equal �NOW� or today�s date; and your Logon ID must have High Priority CR Update permission defined within the SMS/800 system�s HPU screen for the customer record�s Resp Org Entity
