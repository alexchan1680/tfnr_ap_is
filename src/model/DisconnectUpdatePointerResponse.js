...
/**
* The DisconnectUpdatePointerResponse model module.
* @module model/DisconnectUpdatePointerResponse
* @version v1
*/
export default class DisconnectUpdatePointerResponse {
    /**
    * Constructs a new <code>DisconnectUpdatePointerResponse</code>.
    * @alias module:model/DisconnectUpdatePointerResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>DisconnectUpdatePointerResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DisconnectUpdatePointerResponse} obj Optional instance to populate.
    * @return {module:model/DisconnectUpdatePointerResponse} The populated <code>DisconnectUpdatePointerResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisconnectUpdatePointerResponse();
