...
/**
* Enum class EnableBlocking.
* @enum {}
* @readonly
*/
export default class EnableBlocking {
    ...
    /**
    * Returns a <code>EnableBlocking</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EnableBlocking} The enum <code>EnableBlocking</code> value.
    */
