...
/**
* The Err model module.
* @module model/Err
* @version v1
*/
export default class Err {
    /**
    * Constructs a new <code>Err</code>.
    * @alias module:model/Err
    * @class
    */
    ...
    /**
    * Constructs a <code>Err</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/Err} obj Optional instance to populate.
    * @return {module:model/Err} The populated <code>Err</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('errLvl')) {
                obj['errLvl'] = ErrLvl.constructFromObject(data['errLvl']);
            }
        }
        return obj;
    }
    ...
    */
    errMsg = undefined;
    /**
    * @member {module:model/ErrLvl} errLvl
    */
    errLvl = undefined;
