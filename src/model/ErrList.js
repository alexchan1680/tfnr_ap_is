...
/**
* The ErrList model module.
* @module model/ErrList
* @version v1
*/
export default class ErrList extends Array {
    /**
    * Constructs a new <code>ErrList</code>.
    * @alias module:model/ErrList
    * @class
    * @extends Array
    */
    ...
    /**
    * Constructs a <code>ErrList</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ErrList} obj Optional instance to populate.
    * @return {module:model/ErrList} The populated <code>ErrList</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ErrList();

            ApiClient.constructFromObject(data, obj, 'Err');
