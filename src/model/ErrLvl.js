...
export default class ErrLvl {
    ...
    /**
    * Returns a <code>ErrLvl</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ErrLvl} The enum <code>ErrLvl</code> value.
    */
