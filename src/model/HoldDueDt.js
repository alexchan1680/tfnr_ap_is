...
/**
* Enum class HoldDueDt.
* @enum {}
* @readonly
*/
export default class HoldDueDt {
    ...
    /**
    * Returns a <code>HoldDueDt</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/HoldDueDt} The enum <code>HoldDueDt</code> value.
    */
