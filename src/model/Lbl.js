...
/**
* The Lbl model module.
* @module model/Lbl
* @version v1
*/
export default class Lbl {
    /**
    * Constructs a new <code>Lbl</code>.
    * @alias module:model/Lbl
    * @class
    */
    ...
    /**
    * Constructs a <code>Lbl</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/Lbl} obj Optional instance to populate.
    * @return {module:model/Lbl} The populated <code>Lbl</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('lblType')) {
                obj['lblType'] = LblType.constructFromObject(data['lblType']);
            }
            if (data.hasOwnProperty('lblName')) {
                obj['lblName'] = ApiClient.convertToType(data['lblName'], 'String');
            }
            if (data.hasOwnProperty('lblVals')) {
                obj['lblVals'] = ApiClient.convertToType(data['lblVals'], ['String']);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {module:model/LblType} lblType
    */
    lblType = undefined;
    /**
    * Label Name
    * @member {String} lblName
    */
    lblName = undefined;
    /**
    * @member {Array.<String>} lblVals
    */
    lblVals = undefined;
