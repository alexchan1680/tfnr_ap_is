...
export default class LblType {
    ...
    /**
    * Returns a <code>LblType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/LblType} The enum <code>LblType</code> value.
    */
