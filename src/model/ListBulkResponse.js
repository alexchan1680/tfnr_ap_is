...
/**
* The ListBulkResponse model module.
* @module model/ListBulkResponse
* @version v1
*/
export default class ListBulkResponse {
    /**
    * Constructs a new <code>ListBulkResponse</code>.
    * @alias module:model/ListBulkResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>ListBulkResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ListBulkResponse} obj Optional instance to populate.
    * @return {module:model/ListBulkResponse} The populated <code>ListBulkResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListBulkResponse();

            
            
            

            if (data.hasOwnProperty('blkLst')) {
                obj['blkLst'] = ApiClient.convertToType(data['blkLst'], [BlkLst]);
            }
    ...
    /**
    * @member {Array.<module:model/BlkLst>} blkLst
    */
    blkLst = undefined;
    /**
