...
/**
* The LstEffDtTms model module.
* @module model/LstEffDtTms
* @version v1
*/
export default class LstEffDtTms {
    /**
    * Constructs a new <code>LstEffDtTms</code>.
    * @alias module:model/LstEffDtTms
    * @class
    */
    ...
    /**
    * Constructs a <code>LstEffDtTms</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/LstEffDtTms} obj Optional instance to populate.
    * @return {module:model/LstEffDtTms} The populated <code>LstEffDtTms</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LstEffDtTms();
