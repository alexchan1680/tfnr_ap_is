...
export default class Nodes {
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('pctAlloc')) {
                obj['pctAlloc'] = ApiClient.convertToType(data['pctAlloc'], 'String');
            }
            if (data.hasOwnProperty('switchs')) {
                obj['switchs'] = ApiClient.convertToType(data['switchs'], 'String');
            }
            ...
            if (data.hasOwnProperty('sixDigit')) {
                obj['sixDigit'] = ApiClient.convertToType(data['sixDigit'], ['String']);
            }
            if (data.hasOwnProperty('tenDigit')) {
                obj['tenDigit'] = ApiClient.convertToType(data['tenDigit'], 'String');
            }
            if (data.hasOwnProperty('carrier')) {
                obj['carrier'] = ApiClient.convertToType(data['carrier'], 'String');
            }
            if (data.hasOwnProperty('termNum')) {
                obj['termNum'] = ApiClient.convertToType(data['termNum'], 'String');
            }
    ...
    */
    state = undefined;
    /**
    * @member {String} pctAlloc
    */
    pctAlloc = undefined;
    /**
    * @member {String} switchs
    */
    switchs = undefined;
    /**
    ...
    */
    ...
    /**
    * @member {Array.<String>} lata
    */
    lata = undefined;
    /**
    * NXX
    * @member {Array.<String>} nxx
    */
    nxx = undefined;
    /**
    * Six Digit
    * @member {Array.<String>} sixDigit
    */
    sixDigit = undefined;
    /**
    * Ten Digit
    * @member {String} tenDigit
    */
    tenDigit = undefined;
    /**
