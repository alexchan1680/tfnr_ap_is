...
/**
* Enum class NumAllocInd.
* @enum {}
* @readonly
*/
export default class NumAllocInd {
    ...
    /**
    * Returns a <code>NumAllocInd</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/NumAllocInd} The enum <code>NumAllocInd</code> value.
    */
