...
/**
* The NumberQueryResponse model module.
* @module model/NumberQueryResponse
* @version v1
*/
export default class NumberQueryResponse {
    /**
    * Constructs a new <code>NumberQueryResponse</code>.
    * @alias module:model/NumberQueryResponse
    * @class
    * @param lastActDt {String} 
    * @param resUntilDt {String} 
    * @param discUntilDt {String} 
    * @param effDt {String} 
    * @param stat {module:model/Stat} 
    * @param ctlRespOrg {String} 
    * @param conName {String} Name of ContactNo numbers allowed
    * @param conPhone {String} 
    * @param shrtNotes {String} 
    */

    constructor(lastActDt, resUntilDt, discUntilDt, effDt, stat, ctlRespOrg, conName, conPhone, shrtNotes) {
        

        
        

        this['lastActDt'] = lastActDt;this['resUntilDt'] = resUntilDt;this['discUntilDt'] = discUntilDt;this['effDt'] = effDt;this['stat'] = stat;this['ctlRespOrg'] = ctlRespOrg;this['conName'] = conName;this['conPhone'] = conPhone;this['shrtNotes'] = shrtNotes;

        
    }

    /**
    * Constructs a <code>NumberQueryResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/NumberQueryResponse} obj Optional instance to populate.
    * @return {module:model/NumberQueryResponse} The populated <code>NumberQueryResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NumberQueryResponse();

            
            
            

            if (data.hasOwnProperty('lastActDt')) {
                obj['lastActDt'] = ApiClient.convertToType(data['lastActDt'], 'String');
            }
            if (data.hasOwnProperty('resUntilDt')) {
                obj['resUntilDt'] = ApiClient.convertToType(data['resUntilDt'], 'String');
            }
            if (data.hasOwnProperty('discUntilDt')) {
                obj['discUntilDt'] = ApiClient.convertToType(data['discUntilDt'], 'String');
            }
            if (data.hasOwnProperty('effDt')) {
                obj['effDt'] = ApiClient.convertToType(data['effDt'], 'String');
            }
            if (data.hasOwnProperty('stat')) {
                obj['stat'] = Stat.constructFromObject(data['stat']);
            }
            if (data.hasOwnProperty('ctlRespOrg')) {
                obj['ctlRespOrg'] = ApiClient.convertToType(data['ctlRespOrg'], 'String');
            }
    ...
    /**
    * @member {String} lastActDt
    */
    lastActDt = undefined;
    /**
    * @member {String} resUntilDt
    */
    resUntilDt = undefined;
    /**
    * @member {String} discUntilDt
    */
    discUntilDt = undefined;
    /**
    * @member {String} effDt
    */
    effDt = undefined;
    ...
    */
    stat = undefined;
    /**
    * @member {String} ctlRespOrg
    */
    ctlRespOrg = undefined;
    /**
