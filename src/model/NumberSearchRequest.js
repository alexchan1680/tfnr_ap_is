...
/**
* The NumberSearchRequest model module.
* @module model/NumberSearchRequest
* @version v1
*/
export default class NumberSearchRequest {
    /**
    * Constructs a new <code>NumberSearchRequest</code>.
    * @alias module:model/NumberSearchRequest
    * @class
    */
    ...
    /**
    * Constructs a <code>NumberSearchRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/NumberSearchRequest} obj Optional instance to populate.
    * @return {module:model/NumberSearchRequest} The populated <code>NumberSearchRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NumberSearchRequest();
