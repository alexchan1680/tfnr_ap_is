...
/**
* The NumberSearchReserveRequest model module.
* @module model/NumberSearchReserveRequest
* @version v1
*/
export default class NumberSearchReserveRequest {
    /**
    * Constructs a new <code>NumberSearchReserveRequest</code>.
    * @alias module:model/NumberSearchReserveRequest
    * @class
    * @param conName {String} Name of Contact. No numbers allowed
    * @param conPhone {String} 
    */

    constructor(conName, conPhone) {
        

        
        

        this['conName'] = conName;this['conPhone'] = conPhone;

        
    }

    /**
    * Constructs a <code>NumberSearchReserveRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/NumberSearchReserveRequest} obj Optional instance to populate.
    * @return {module:model/NumberSearchReserveRequest} The populated <code>NumberSearchReserveRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NumberSearchReserveRequest();
