...
/**
* The NumberSearchReserveResponse model module.
* @module model/NumberSearchReserveResponse
* @version v1
*/
export default class NumberSearchReserveResponse {
    /**
    * Constructs a new <code>NumberSearchReserveResponse</code>.
    * @alias module:model/NumberSearchReserveResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>NumberSearchReserveResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/NumberSearchReserveResponse} obj Optional instance to populate.
    * @return {module:model/NumberSearchReserveResponse} The populated <code>NumberSearchReserveResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NumberSearchReserveResponse();
