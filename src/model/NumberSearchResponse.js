...
/**
* The NumberSearchResponse model module.
* @module model/NumberSearchResponse
* @version v1
*/
export default class NumberSearchResponse {
    /**
    * Constructs a new <code>NumberSearchResponse</code>.
    * @alias module:model/NumberSearchResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>NumberSearchResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/NumberSearchResponse} obj Optional instance to populate.
    * @return {module:model/NumberSearchResponse} The populated <code>NumberSearchResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NumberSearchResponse();
            ...
            if (data.hasOwnProperty('lastActDtList')) {
                obj['lastActDtList'] = ApiClient.convertToType(data['lastActDtList'], ['String']);
            }
    ...
    */
    numList = undefined;
    /**
    * @member {Array.<String>} lastActDtList
    */
    lastActDtList = undefined;
    /**
