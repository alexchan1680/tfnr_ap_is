...
/**
* The NumberSpareRequest model module.
* @module model/NumberSpareRequest
* @version v1
*/
export default class NumberSpareRequest {
    /**
    * Constructs a new <code>NumberSpareRequest</code>.
    * @alias module:model/NumberSpareRequest
    * @class
    * @param numList {Array.<String>} List of Dialed Numbers successfully processed. Format is npanxxxxxx
    */
    ...
    /**
    * Constructs a <code>NumberSpareRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/NumberSpareRequest} obj Optional instance to populate.
    * @return {module:model/NumberSpareRequest} The populated <code>NumberSpareRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NumberSpareRequest();
