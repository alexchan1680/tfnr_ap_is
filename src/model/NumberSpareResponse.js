...
/**
* The NumberSpareResponse model module.
* @module model/NumberSpareResponse
* @version v1
*/
export default class NumberSpareResponse {
    /**
    * Constructs a new <code>NumberSpareResponse</code>.
    * @alias module:model/NumberSpareResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>NumberSpareResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/NumberSpareResponse} obj Optional instance to populate.
    * @return {module:model/NumberSpareResponse} The populated <code>NumberSpareResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NumberSpareResponse();
    ...
    /**
    * List of Dialed Numbers successfully processed. Format is npanxxxxxx
