...
/**
* The NumberUpdateRequest model module.
* @module model/NumberUpdateRequest
* @version v1
*/
export default class NumberUpdateRequest {
    /**
    * Constructs a new <code>NumberUpdateRequest</code>.
    * @alias module:model/NumberUpdateRequest
    * @class
    */
    ...
    /**
    * Constructs a <code>NumberUpdateRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/NumberUpdateRequest} obj Optional instance to populate.
    * @return {module:model/NumberUpdateRequest} The populated <code>NumberUpdateRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NumberUpdateRequest();
