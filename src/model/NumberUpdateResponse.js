...
/**
* The NumberUpdateResponse model module.
* @module model/NumberUpdateResponse
* @version v1
*/
export default class NumberUpdateResponse {
    /**
    * Constructs a new <code>NumberUpdateResponse</code>.
    * @alias module:model/NumberUpdateResponse
    * @class
    ...
    */
    ...
    constructor(resUntilDt, effDt, stat, ctlRespOrg, conName, conPhone, shrtNotes) {
        

        
        

        this['resUntilDt'] = resUntilDt;this['effDt'] = effDt;this['stat'] = stat;this['ctlRespOrg'] = ctlRespOrg;this['conName'] = conName;this['conPhone'] = conPhone;this['shrtNotes'] = shrtNotes;

        
    }

    /**
    * Constructs a <code>NumberUpdateResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/NumberUpdateResponse} obj Optional instance to populate.
    * @return {module:model/NumberUpdateResponse} The populated <code>NumberUpdateResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NumberUpdateResponse();
