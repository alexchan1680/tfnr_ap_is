...
/**
* The OneClickActivateResponse model module.
* @module model/OneClickActivateResponse
* @version v1
*/
export default class OneClickActivateResponse {
    /**
    * Constructs a new <code>OneClickActivateResponse</code>.
    * @alias module:model/OneClickActivateResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>OneClickActivateResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OneClickActivateResponse} obj Optional instance to populate.
    * @return {module:model/OneClickActivateResponse} The populated <code>OneClickActivateResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OneClickActivateResponse();
            ...
            if (data.hasOwnProperty('blkResp')) {
                obj['blkResp'] = ApiClient.convertToType(data['blkResp'], [BlkResp]);
            }
    ...
    */
    blkId = undefined;
    /**
    * Request ID is an identifier used to retrieve response later incase there is a delay in response due to timeout
    * @member {Number} requestId
    */
    requestId = undefined;
    /**
    * Bulk response
    * @member {Array.<module:model/BlkResp>} blkResp
    */
    blkResp = undefined;
    /**
