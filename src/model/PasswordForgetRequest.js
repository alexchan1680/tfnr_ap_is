...
/**
* The PasswordForgetRequest model module.
* @module model/PasswordForgetRequest
* @version v1
*/
export default class PasswordForgetRequest {
    /**
    * Constructs a new <code>PasswordForgetRequest</code>.
    * @alias module:model/PasswordForgetRequest
    * @class
    * @param loginID {String} User Name/LogonId
    */
    ...
    /**
    * Constructs a <code>PasswordForgetRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PasswordForgetRequest} obj Optional instance to populate.
    * @return {module:model/PasswordForgetRequest} The populated <code>PasswordForgetRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PasswordForgetRequest();
