...
/**
* The PasswordForgetResponse model module.
* @module model/PasswordForgetResponse
* @version v1
*/
export default class PasswordForgetResponse {
    /**
    * Constructs a new <code>PasswordForgetResponse</code>.
    * @alias module:model/PasswordForgetResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>PasswordForgetResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PasswordForgetResponse} obj Optional instance to populate.
    * @return {module:model/PasswordForgetResponse} The populated <code>PasswordForgetResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PasswordForgetResponse();
