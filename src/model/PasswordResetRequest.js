...
export default class PasswordResetRequest {
    ...
    * @class
    * @param usrLoginId {String} 
    * @param confirmationCode {String} 
    * @param newPassword {String} 
    */

    constructor(usrLoginId, confirmationCode, newPassword) {
        

        
        

        this['usrLoginId'] = usrLoginId;this['confirmationCode'] = confirmationCode;this['newPassword'] = newPassword;
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('usrLoginId')) {
                obj['usrLoginId'] = ApiClient.convertToType(data['usrLoginId'], 'String');
            }
    ...
    /**
    * @member {String} usrLoginId
    */
    usrLoginId = undefined;
    /**
