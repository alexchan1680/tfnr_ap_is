...
/**
* The PasswordResetResponse model module.
* @module model/PasswordResetResponse
* @version v1
*/
export default class PasswordResetResponse {
    /**
    * Constructs a new <code>PasswordResetResponse</code>.
    * @alias module:model/PasswordResetResponse
    * @class
    * @param errList {module:model/ErrList} 
    */
    ...
    /**
    * Constructs a <code>PasswordResetResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PasswordResetResponse} obj Optional instance to populate.
    * @return {module:model/PasswordResetResponse} The populated <code>PasswordResetResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PasswordResetResponse();
