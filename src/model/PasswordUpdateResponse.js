...
/**
* The PasswordUpdateResponse model module.
* @module model/PasswordUpdateResponse
* @version v1
*/
export default class PasswordUpdateResponse {
    /**
    * Constructs a new <code>PasswordUpdateResponse</code>.
    * @alias module:model/PasswordUpdateResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>PasswordUpdateResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PasswordUpdateResponse} obj Optional instance to populate.
    * @return {module:model/PasswordUpdateResponse} The populated <code>PasswordUpdateResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PasswordUpdateResponse();
    ...
    /**
    * @member {module:model/PasswordUpdateResponse.StatusEnum} status
    */
    status = undefined;
    /**
