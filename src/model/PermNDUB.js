...
export default class PermNDUB {
    ...
    /**
    * Returns a <code>PermNDUB</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PermNDUB} The enum <code>PermNDUB</code> value.
    */
