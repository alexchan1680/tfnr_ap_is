...
export default class PermNV {
    ...
    /**
    * Returns a <code>PermNV</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PermNV} The enum <code>PermNV</code> value.
    */
