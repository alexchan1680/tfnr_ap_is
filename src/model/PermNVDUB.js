...
/**
* Enum class PermNVDUB.
* @enum {}
* @readonly
*/
export default class PermNVDUB {
    ...
    /**
    * Returns a <code>PermNVDUB</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PermNVDUB} The enum <code>PermNVDUB</code> value.
    */
