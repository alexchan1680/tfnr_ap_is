...
export default class PermNVU {
    ...
    /**
    * Returns a <code>PermNVU</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PermNVU} The enum <code>PermNVU</code> value.
    */
