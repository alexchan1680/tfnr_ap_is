...
export default class PermNY {
    ...
    /**
    * Returns a <code>PermNY</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PermNY} The enum <code>PermNY</code> value.
    */
