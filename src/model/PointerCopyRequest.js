...
/**
* The PointerCopyRequest model module.
* @module model/PointerCopyRequest
* @version v1
*/
export default class PointerCopyRequest {
    /**
    * Constructs a new <code>PointerCopyRequest</code>.
    * @alias module:model/PointerCopyRequest
    * @class
    * @param num {String} Dialed number of the record 
    * @param effDtTm {String} Effective date and time of the records
    * @param srcEffDtTm {String} Source Effective date and time of the recordsISO 8601
    ...
    */
    ...
    /**
    * Constructs a <code>PointerCopyRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PointerCopyRequest} obj Optional instance to populate.
    * @return {module:model/PointerCopyRequest} The populated <code>PointerCopyRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PointerCopyRequest();
    ...
    */
    effDtTm = undefined;
    /**
    * Source Effective date and time of the recordsISO 8601
