...
/**
* The PointerCopyResponse model module.
* @module model/PointerCopyResponse
* @version v1
*/
export default class PointerCopyResponse {
    /**
    * Constructs a new <code>PointerCopyResponse</code>.
    * @alias module:model/PointerCopyResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>PointerCopyResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PointerCopyResponse} obj Optional instance to populate.
    * @return {module:model/PointerCopyResponse} The populated <code>PointerCopyResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PointerCopyResponse();
