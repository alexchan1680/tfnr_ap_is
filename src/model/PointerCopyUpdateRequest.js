...
/**
* The PointerCopyUpdateRequest model module.
* @module model/PointerCopyUpdateRequest
* @version v1
*/
export default class PointerCopyUpdateRequest {
    /**
    * Constructs a new <code>PointerCopyUpdateRequest</code>.
    * @alias module:model/PointerCopyUpdateRequest
    * @class
    ...
    * @param tempName {String} This is a 15 byte text field (starts with *) containing the Template 
    ...
    */
    ...
    /**
    * Constructs a <code>PointerCopyUpdateRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PointerCopyUpdateRequest} obj Optional instance to populate.
    * @return {module:model/PointerCopyUpdateRequest} The populated <code>PointerCopyUpdateRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PointerCopyUpdateRequest();
