...
/**
* The PointerCopyUpdateResponse model module.
* @module model/PointerCopyUpdateResponse
* @version v1
*/
export default class PointerCopyUpdateResponse {
    /**
    * Constructs a new <code>PointerCopyUpdateResponse</code>.
    * @alias module:model/PointerCopyUpdateResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>PointerCopyUpdateResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PointerCopyUpdateResponse} obj Optional instance to populate.
    * @return {module:model/PointerCopyUpdateResponse} The populated <code>PointerCopyUpdateResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PointerCopyUpdateResponse();
            ...
            if (data.hasOwnProperty('lstEffDtTm')) {
                obj['lstEffDtTm'] = ApiClient.convertToType(data['lstEffDtTm'], [LstEffDtTms]);
            }
    ...
    * @member {Array.<module:model/LstEffDtTms>} lstEffDtTm
    */
    lstEffDtTm = undefined;
    /**
