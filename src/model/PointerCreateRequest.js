...
/**
* The PointerCreateRequest model module.
* @module model/PointerCreateRequest
* @version v1
*/
export default class PointerCreateRequest {
    /**
    * Constructs a new <code>PointerCreateRequest</code>.
    * @alias module:model/PointerCreateRequest
    * @class
    ...
    */
    ...
    constructor(num, effDtTm, reqSntFrom, cmd, hldIndFlag, tempName, destNums) {
        

        
        

        this['num'] = num;this['effDtTm'] = effDtTm;this['reqSntFrom'] = reqSntFrom;this['cmd'] = cmd;this['hldIndFlag'] = hldIndFlag;this['tempName'] = tempName;this['destNums'] = destNums;

        
    }

    /**
    * Constructs a <code>PointerCreateRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PointerCreateRequest} obj Optional instance to populate.
    * @return {module:model/PointerCreateRequest} The populated <code>PointerCreateRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PointerCreateRequest();
