...
/**
* The PointerCreateResponse model module.
* @module model/PointerCreateResponse
* @version v1
*/
export default class PointerCreateResponse {
    /**
    * Constructs a new <code>PointerCreateResponse</code>.
    * @alias module:model/PointerCreateResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>PointerCreateResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PointerCreateResponse} obj Optional instance to populate.
    * @return {module:model/PointerCreateResponse} The populated <code>PointerCreateResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PointerCreateResponse();
