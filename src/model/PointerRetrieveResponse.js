...
/**
* The PointerRetrieveResponse model module.
* @module model/PointerRetrieveResponse
* @version v1
*/
export default class PointerRetrieveResponse {
    /**
    * Constructs a new <code>PointerRetrieveResponse</code>.
    * @alias module:model/PointerRetrieveResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>PointerRetrieveResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PointerRetrieveResponse} obj Optional instance to populate.
    * @return {module:model/PointerRetrieveResponse} The populated <code>PointerRetrieveResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PointerRetrieveResponse();
            ...
            if (data.hasOwnProperty('onAcctCust')) {
                obj['onAcctCust'] = ApiClient.convertToType(data['onAcctCust'], 'String');
            }
    ...
    */
    co = undefined;
    /**
    * @member {String} onAcctCust
    */
    onAcctCust = undefined;
    /**
