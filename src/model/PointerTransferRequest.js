...
/**
* The PointerTransferRequest model module.
* @module model/PointerTransferRequest
* @version v1
*/
export default class PointerTransferRequest {
    /**
    * Constructs a new <code>PointerTransferRequest</code>.
    * @alias module:model/PointerTransferRequest
    * @class
    ...
    * @param tgtNum {String} Target number of the record 
    ...
    */
    ...
    /**
    * Constructs a <code>PointerTransferRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PointerTransferRequest} obj Optional instance to populate.
    * @return {module:model/PointerTransferRequest} The populated <code>PointerTransferRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PointerTransferRequest();
