...
/**
* The PointerTransferResponse model module.
* @module model/PointerTransferResponse
* @version v1
*/
export default class PointerTransferResponse {
    /**
    * Constructs a new <code>PointerTransferResponse</code>.
    * @alias module:model/PointerTransferResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>PointerTransferResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PointerTransferResponse} obj Optional instance to populate.
    * @return {module:model/PointerTransferResponse} The populated <code>PointerTransferResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PointerTransferResponse();

            
            
            

            if (data.hasOwnProperty('controlRespOrg')) {
                obj['controlRespOrg'] = ApiClient.convertToType(data['controlRespOrg'], 'String');
            }
    ...
    /**
    * Control Resp Org Id
    * @member {String} controlRespOrg
    */
    controlRespOrg = undefined;
    /**
