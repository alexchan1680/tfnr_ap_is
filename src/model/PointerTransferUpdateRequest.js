...
/**
* The PointerTransferUpdateRequest model module.
* @module model/PointerTransferUpdateRequest
* @version v1
*/
export default class PointerTransferUpdateRequest {
    /**
    * Constructs a new <code>PointerTransferUpdateRequest</code>.
    * @alias module:model/PointerTransferUpdateRequest
    * @class
    ...
    */
    ...
    constructor(num, effDtTm, srcEffDtTm, tempName, reqSntFrom, cmd, hldIndFlag, destNums) {
        

        
        

        this['num'] = num;this['effDtTm'] = effDtTm;this['srcEffDtTm'] = srcEffDtTm;this['tempName'] = tempName;this['reqSntFrom'] = reqSntFrom;this['cmd'] = cmd;this['hldIndFlag'] = hldIndFlag;this['destNums'] = destNums;

        
    }

    /**
    * Constructs a <code>PointerTransferUpdateRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PointerTransferUpdateRequest} obj Optional instance to populate.
    * @return {module:model/PointerTransferUpdateRequest} The populated <code>PointerTransferUpdateRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PointerTransferUpdateRequest();
    ...
    */
    ...
    /**
    * Name of ContactNo numbers allowed
