...
import CustRecStat from './CustRecStat';
...
/**
* The PointerTransferUpdateResponse model module.
* @module model/PointerTransferUpdateResponse
* @version v1
*/
export default class PointerTransferUpdateResponse {
    /**
    * Constructs a new <code>PointerTransferUpdateResponse</code>.
    * @alias module:model/PointerTransferUpdateResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>PointerTransferUpdateResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PointerTransferUpdateResponse} obj Optional instance to populate.
    * @return {module:model/PointerTransferUpdateResponse} The populated <code>PointerTransferUpdateResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PointerTransferUpdateResponse();
            ...
            if (data.hasOwnProperty('custRecStat')) {
                obj['custRecStat'] = CustRecStat.constructFromObject(data['custRecStat']);
            }
    ...
    */
    ...
    /**
    * @member {module:model/CustRecStat} custRecStat
    */
    custRecStat = undefined;
    /**
