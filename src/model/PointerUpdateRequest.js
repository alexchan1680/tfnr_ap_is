...
/**
* The PointerUpdateRequest model module.
* @module model/PointerUpdateRequest
* @version v1
*/
export default class PointerUpdateRequest {
    /**
    * Constructs a new <code>PointerUpdateRequest</code>.
    * @alias module:model/PointerUpdateRequest
    * @class
    ...
    */
    ...
    constructor(num, effDtTm, tempName, reqSntFrom, cmd, hldIndFlag, destNums) {
        

        
        

        this['num'] = num;this['effDtTm'] = effDtTm;this['tempName'] = tempName;this['reqSntFrom'] = reqSntFrom;this['cmd'] = cmd;this['hldIndFlag'] = hldIndFlag;this['destNums'] = destNums;

        
    }

    /**
    * Constructs a <code>PointerUpdateRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PointerUpdateRequest} obj Optional instance to populate.
    * @return {module:model/PointerUpdateRequest} The populated <code>PointerUpdateRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PointerUpdateRequest();
