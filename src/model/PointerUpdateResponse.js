...
/**
* The PointerUpdateResponse model module.
* @module model/PointerUpdateResponse
* @version v1
*/
export default class PointerUpdateResponse {
    /**
    * Constructs a new <code>PointerUpdateResponse</code>.
    * @alias module:model/PointerUpdateResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>PointerUpdateResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PointerUpdateResponse} obj Optional instance to populate.
    * @return {module:model/PointerUpdateResponse} The populated <code>PointerUpdateResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PointerUpdateResponse();
