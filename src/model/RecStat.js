...
/**
* The RecStat model module.
* @module model/RecStat
* @version v1
*/
export default class RecStat {
    /**
    * Constructs a new <code>RecStat</code>.
    * @alias module:model/RecStat
    * @class
    */
    ...
    /**
    * Constructs a <code>RecStat</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RecStat} obj Optional instance to populate.
    * @return {module:model/RecStat} The populated <code>RecStat</code> instance.
    */
