...
/**
* The RecordCopyRequest model module.
* @module model/RecordCopyRequest
* @version v1
*/
export default class RecordCopyRequest {
    /**
    * Constructs a new <code>RecordCopyRequest</code>.
    * @alias module:model/RecordCopyRequest
    * @class
    * @param num {String} Dialed number of the record 
    * @param effDtTm {String} Effective date and time of the records
    * @param srcEffDtTm {String} Target Effective date and time of the records
    * @param tgtNum {String} Target number. Format is npanxxxxxx. 10 character string.
    * @param custRecCompPart {module:model/CustRecCompPart} 
    * @param reqSntFrom {module:model/ReqSntFrom} Functional area from where the Customer Record requests were initiated from
    */

    constructor(num, effDtTm, srcEffDtTm, tgtNum, custRecCompPart, reqSntFrom) {
        

        
        

        this['num'] = num;this['effDtTm'] = effDtTm;this['srcEffDtTm'] = srcEffDtTm;this['tgtNum'] = tgtNum;this['custRecCompPart'] = custRecCompPart;this['reqSntFrom'] = reqSntFrom;

        
    }

    /**
    * Constructs a <code>RecordCopyRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RecordCopyRequest} obj Optional instance to populate.
    * @return {module:model/RecordCopyRequest} The populated <code>RecordCopyRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RecordCopyRequest();
    ...
    */
    effDtTm = undefined;
    /**
    * Target Effective date and time of the records
    * @member {String} srcEffDtTm
    */
    srcEffDtTm = undefined;
    /**
    * Target number. Format is npanxxxxxx. 10 character string.
