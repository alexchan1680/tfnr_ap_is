...
/**
* The RecordCopyResponse model module.
* @module model/RecordCopyResponse
* @version v1
*/
export default class RecordCopyResponse {
    /**
    * Constructs a new <code>RecordCopyResponse</code>.
    * @alias module:model/RecordCopyResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>RecordCopyResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RecordCopyResponse} obj Optional instance to populate.
    * @return {module:model/RecordCopyResponse} The populated <code>RecordCopyResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RecordCopyResponse();
