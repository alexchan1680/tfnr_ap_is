...
/**
* The RecordCopyUpdateResponse model module.
* @module model/RecordCopyUpdateResponse
* @version v1
*/
export default class RecordCopyUpdateResponse {
    /**
    * Constructs a new <code>RecordCopyUpdateResponse</code>.
    * @alias module:model/RecordCopyUpdateResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>RecordCopyUpdateResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RecordCopyUpdateResponse} obj Optional instance to populate.
    * @return {module:model/RecordCopyUpdateResponse} The populated <code>RecordCopyUpdateResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RecordCopyUpdateResponse();
