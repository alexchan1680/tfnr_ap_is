...
/**
* The RecordCreateRequest model module.
* @module model/RecordCreateRequest
* @version v1
*/
export default class RecordCreateRequest {
    /**
    * Constructs a new <code>RecordCreateRequest</code>.
    * @alias module:model/RecordCreateRequest
    * @class
    * @param num {String} Dialed number of the record. Format is npanxxxxxx. 10 character string.
    * @param effDtTm {String} Effective date and time of the recordsISO 8601
    ...
    */
    ...
    /**
    * Constructs a <code>RecordCreateRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RecordCreateRequest} obj Optional instance to populate.
    * @return {module:model/RecordCreateRequest} The populated <code>RecordCreateRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RecordCreateRequest();
    ...
    */
    num = undefined;
    /**
    * Effective date and time of the recordsISO 8601
