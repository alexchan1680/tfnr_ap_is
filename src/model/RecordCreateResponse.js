...
/**
* The RecordCreateResponse model module.
* @module model/RecordCreateResponse
* @version v1
*/
export default class RecordCreateResponse {
    /**
    * Constructs a new <code>RecordCreateResponse</code>.
    * @alias module:model/RecordCreateResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>RecordCreateResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RecordCreateResponse} obj Optional instance to populate.
    * @return {module:model/RecordCreateResponse} The populated <code>RecordCreateResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RecordCreateResponse();
