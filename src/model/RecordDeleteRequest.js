...
/**
* The RecordDeleteRequest model module.
* @module model/RecordDeleteRequest
* @version v1
*/
export default class RecordDeleteRequest {
    /**
    * Constructs a new <code>RecordDeleteRequest</code>.
    * @alias module:model/RecordDeleteRequest
    * @class
    ...
    */
    ...
    constructor(num, effDtTm, custRecCompPart, reqSntFrom) {
        

        
        

        this['num'] = num;this['effDtTm'] = effDtTm;this['custRecCompPart'] = custRecCompPart;this['reqSntFrom'] = reqSntFrom;

        
    }

    /**
    * Constructs a <code>RecordDeleteRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RecordDeleteRequest} obj Optional instance to populate.
    * @return {module:model/RecordDeleteRequest} The populated <code>RecordDeleteRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RecordDeleteRequest();
