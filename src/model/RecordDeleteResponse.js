...
/**
* The RecordDeleteResponse model module.
* @module model/RecordDeleteResponse
* @version v1
*/
export default class RecordDeleteResponse {
    /**
    * Constructs a new <code>RecordDeleteResponse</code>.
    * @alias module:model/RecordDeleteResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>RecordDeleteResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RecordDeleteResponse} obj Optional instance to populate.
    * @return {module:model/RecordDeleteResponse} The populated <code>RecordDeleteResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RecordDeleteResponse();
