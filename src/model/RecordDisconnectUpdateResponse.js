...
/**
* The RecordDisconnectUpdateResponse model module.
* @module model/RecordDisconnectUpdateResponse
* @version v1
*/
export default class RecordDisconnectUpdateResponse {
    /**
    * Constructs a new <code>RecordDisconnectUpdateResponse</code>.
    * @alias module:model/RecordDisconnectUpdateResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>RecordDisconnectUpdateResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RecordDisconnectUpdateResponse} obj Optional instance to populate.
    * @return {module:model/RecordDisconnectUpdateResponse} The populated <code>RecordDisconnectUpdateResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RecordDisconnectUpdateResponse();
