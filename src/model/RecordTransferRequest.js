...
/**
* The RecordTransferRequest model module.
* @module model/RecordTransferRequest
* @version v1
*/
export default class RecordTransferRequest {
    /**
    * Constructs a new <code>RecordTransferRequest</code>.
    * @alias module:model/RecordTransferRequest
    * @class
    ...
    * @param tgtNum {String} Target number
    ...
    */
    ...
    /**
    * Constructs a <code>RecordTransferRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RecordTransferRequest} obj Optional instance to populate.
    * @return {module:model/RecordTransferRequest} The populated <code>RecordTransferRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RecordTransferRequest();
