...
/**
* The RecordTransferUpdateResponse model module.
* @module model/RecordTransferUpdateResponse
* @version v1
*/
export default class RecordTransferUpdateResponse {
    /**
    * Constructs a new <code>RecordTransferUpdateResponse</code>.
    * @alias module:model/RecordTransferUpdateResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>RecordTransferUpdateResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RecordTransferUpdateResponse} obj Optional instance to populate.
    * @return {module:model/RecordTransferUpdateResponse} The populated <code>RecordTransferUpdateResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RecordTransferUpdateResponse();
