...
/**
* The RecordUpdateResponse model module.
* @module model/RecordUpdateResponse
* @version v1
*/
export default class RecordUpdateResponse {
    /**
    * Constructs a new <code>RecordUpdateResponse</code>.
    * @alias module:model/RecordUpdateResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>RecordUpdateResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RecordUpdateResponse} obj Optional instance to populate.
    * @return {module:model/RecordUpdateResponse} The populated <code>RecordUpdateResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RecordUpdateResponse();
