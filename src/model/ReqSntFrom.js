...
/**
* Enum class ReqSntFrom.
* @enum {}
* @readonly
*/
export default class ReqSntFrom {
    ...
    /**
    * Returns a <code>ReqSntFrom</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ReqSntFrom} The enum <code>ReqSntFrom</code> value.
    */
