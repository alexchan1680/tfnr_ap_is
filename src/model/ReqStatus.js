...
* @readonly
*/
export default class ReqStatus {
    ...
    /**
    * Returns a <code>ReqStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ReqStatus} The enum <code>ReqStatus</code> value.
    */
