...
* @readonly
*/
export default class ReqType {
    
        /**
         * value: "BULK_SEARCH_RESERVE"
         * @const
         */
        SEARCH_RESERVE = "BULK_SEARCH_RESERVE";

    
        /**
         * value: "BULK_ONE_CLICK_ACTIVATE"
         * @const
         */
        ONE_CLICK_ACTIVATE = "BULK_ONE_CLICK_ACTIVATE";

    

    /**
    * Returns a <code>ReqType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ReqType} The enum <code>ReqType</code> value.
    */
