...
/**
* The RespOrgList model module.
* @module model/RespOrgList
* @version v1
*/
export default class RespOrgList {
    /**
    * Constructs a new <code>RespOrgList</code>.
    * @alias module:model/RespOrgList
    * @class
    */
    ...
    /**
    * Constructs a <code>RespOrgList</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RespOrgList} obj Optional instance to populate.
    * @return {module:model/RespOrgList} The populated <code>RespOrgList</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RespOrgList();

            
            
            

            if (data.hasOwnProperty('respOrgList')) {
                obj['respOrgList'] = ApiClient.convertToType(data['respOrgList'], ['String']);
            }
        }
        return obj;
    }
    ...
    /**
    * RespOrg List
    * @member {Array.<String>} respOrgList
    */
    respOrgList = undefined;
