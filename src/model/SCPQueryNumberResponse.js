...
import ScpRecsQuery from './ScpRecsQuery';
...
/**
* The SCPQueryNumberResponse model module.
* @module model/SCPQueryNumberResponse
* @version v1
*/
export default class SCPQueryNumberResponse {
    /**
    * Constructs a new <code>SCPQueryNumberResponse</code>.
    * @alias module:model/SCPQueryNumberResponse
    * @class
    * @param recNum {String} 
    */
    ...
    /**
    * Constructs a <code>SCPQueryNumberResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/SCPQueryNumberResponse} obj Optional instance to populate.
    * @return {module:model/SCPQueryNumberResponse} The populated <code>SCPQueryNumberResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SCPQueryNumberResponse();
            ...
            if (data.hasOwnProperty('scpRecs')) {
                obj['scpRecs'] = ApiClient.convertToType(data['scpRecs'], [ScpRecsQuery]);
            }
    ...
    */
    recStat = undefined;
    /**
    * @member {Array.<module:model/ScpRecsQuery>} scpRecs
    */
    scpRecs = undefined;
    /**
