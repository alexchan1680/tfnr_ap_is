...
/**
* The SCPResendRequest model module.
* @module model/SCPResendRequest
* @version v1
*/
export default class SCPResendRequest {
    /**
    * Constructs a new <code>SCPResendRequest</code>.
    * @alias module:model/SCPResendRequest
    * @class
    * @param recNum {String} 
    ...
    */
    ...
    /**
    * Constructs a <code>SCPResendRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/SCPResendRequest} obj Optional instance to populate.
    * @return {module:model/SCPResendRequest} The populated <code>SCPResendRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SCPResendRequest();
