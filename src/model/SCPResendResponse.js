...
/**
* The SCPResendResponse model module.
* @module model/SCPResendResponse
* @version v1
*/
export default class SCPResendResponse {
    /**
    * Constructs a new <code>SCPResendResponse</code>.
    * @alias module:model/SCPResendResponse
    * @class
    * @param recNum {String} 
    */
    ...
    /**
    * Constructs a <code>SCPResendResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/SCPResendResponse} obj Optional instance to populate.
    * @return {module:model/SCPResendResponse} The populated <code>SCPResendResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SCPResendResponse();
