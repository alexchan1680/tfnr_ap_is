...
/**
* Enum class ScpRecStat.
* @enum {}
* @readonly
*/
export default class ScpRecStat {
    ...
    /**
    * Returns a <code>ScpRecStat</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ScpRecStat} The enum <code>ScpRecStat</code> value.
    */
