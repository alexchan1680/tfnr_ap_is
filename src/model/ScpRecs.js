...
/**
* The ScpRecs model module.
* @module model/ScpRecs
* @version v1
*/
export default class ScpRecs {
    /**
    * Constructs a new <code>ScpRecs</code>.
    * @alias module:model/ScpRecs
    * @class
    */
    ...
    /**
    * Constructs a <code>ScpRecs</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ScpRecs} obj Optional instance to populate.
    * @return {module:model/ScpRecs} The populated <code>ScpRecs</code> instance.
    */
