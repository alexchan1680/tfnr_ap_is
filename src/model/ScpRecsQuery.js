...
import ScpRecStat from './ScpRecStat';
...
/**
* The ScpRecsQuery model module.
* @module model/ScpRecsQuery
* @version v1
*/
export default class ScpRecsQuery {
    /**
    * Constructs a new <code>ScpRecsQuery</code>.
    * @alias module:model/ScpRecsQuery
    * @class
    */
    ...
    /**
    * Constructs a <code>ScpRecsQuery</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ScpRecsQuery} obj Optional instance to populate.
    * @return {module:model/ScpRecsQuery} The populated <code>ScpRecsQuery</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScpRecsQuery();

            
            
            

            if (data.hasOwnProperty('scpId')) {
                obj['scpId'] = ApiClient.convertToType(data['scpId'], 'String');
            }
            if (data.hasOwnProperty('scpRecStat')) {
                obj['scpRecStat'] = ScpRecStat.constructFromObject(data['scpRecStat']);
            }
            if (data.hasOwnProperty('inAOS')) {
                obj['inAOS'] = BoolYN.constructFromObject(data['inAOS']);
            }
        }
        return obj;
    }
    ...
    */
    scpId = undefined;
    /**
    * @member {module:model/ScpRecStat} scpRecStat
    */
    scpRecStat = undefined;
    /**
    * @member {module:model/BoolYN} inAOS
    */
    inAOS = undefined;
