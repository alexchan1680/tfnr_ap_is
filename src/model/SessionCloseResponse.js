...
/**
* The SessionCloseResponse model module.
* @module model/SessionCloseResponse
* @version v1
*/
export default class SessionCloseResponse {
    /**
    * Constructs a new <code>SessionCloseResponse</code>.
    * @alias module:model/SessionCloseResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>SessionCloseResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/SessionCloseResponse} obj Optional instance to populate.
    * @return {module:model/SessionCloseResponse} The populated <code>SessionCloseResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SessionCloseResponse();
    ...
    /**
    * @member {module:model/SessionCloseResponse.StatusEnum} status
    */
    status = undefined;
    /**
