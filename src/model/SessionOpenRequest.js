...
/**
* The SessionOpenRequest model module.
* @module model/SessionOpenRequest
* @version v1
*/
export default class SessionOpenRequest {
    /**
    * Constructs a new <code>SessionOpenRequest</code>.
    * @alias module:model/SessionOpenRequest
    * @class
    * @param usrName {String} User Name/LogonId
    ...
    */
    ...
    constructor(usrName, password) {
        ...
        this['usrName'] = usrName;this['password'] = password;

        
    }

    /**
    * Constructs a <code>SessionOpenRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/SessionOpenRequest} obj Optional instance to populate.
    * @return {module:model/SessionOpenRequest} The populated <code>SessionOpenRequest</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SessionOpenRequest();
            ...
            if (data.hasOwnProperty('withPerm')) {
                obj['withPerm'] = ApiClient.convertToType(data['withPerm'], 'Boolean');
            }
        }
        return obj;
    }
