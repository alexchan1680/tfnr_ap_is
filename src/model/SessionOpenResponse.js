...
import PermRecord from './PermRecord';
...
/**
* The SessionOpenResponse model module.
* @module model/SessionOpenResponse
* @version v1
*/
export default class SessionOpenResponse {
    /**
    * Constructs a new <code>SessionOpenResponse</code>.
    * Without Permission
    * @alias module:model/SessionOpenResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>SessionOpenResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/SessionOpenResponse} obj Optional instance to populate.
    * @return {module:model/SessionOpenResponse} The populated <code>SessionOpenResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SessionOpenResponse();
            ...
            if (data.hasOwnProperty('permRecord')) {
                obj['permRecord'] = PermRecord.constructFromObject(data['permRecord']);
            }
    ...
    /**
    * This token is valid for 60 mins. and should be passed as 'Authorization: Bearer oauthToken' header when invoking the APIs
    * @member {String} oauthToken
    */
    oauthToken = undefined;
    /**
    * This token is valid for 24hrs. and should be used for obtaining a new token using the OAuth 2.0 refresh_grant flow.
    * @member {String} refreshToken
    */
    refreshToken = undefined;
    /**
    * Client Key can be used for OAuth2.0 password and refresh grants. This key never expires unless revoked by the administrator. Never share your client key and secret with others.
    * @member {String} clientKey
    */
    clientKey = undefined;
    /**
    * Client Secret can be used for OAuth2.0 password and refresh grants. This key never expires unless revoked by the administrator. Never share your client key and secret with others.
    ...
    */
    ...
    /**
    * With Permissions
    * @member {module:model/PermRecord} permRecord
    */
