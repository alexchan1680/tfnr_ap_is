...
/**
* The TRQResult model module.
* @module model/TRQResult
* @version v1
*/
export default class TRQResult {
    /**
    * Constructs a new <code>TRQResult</code>.
    * @alias module:model/TRQResult
    * @class
    */
    ...
    /**
    * Constructs a <code>TRQResult</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/TRQResult} obj Optional instance to populate.
    * @return {module:model/TRQResult} The populated <code>TRQResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TRQResult();

            
            
            

            if (data.hasOwnProperty('dialNum')) {
                obj['dialNum'] = ApiClient.convertToType(data['dialNum'], 'String');
            }
            if (data.hasOwnProperty('respOrgQueried')) {
                obj['respOrgQueried'] = ApiClient.convertToType(data['respOrgQueried'], 'String');
            }
            if (data.hasOwnProperty('respOrgName')) {
                obj['respOrgName'] = ApiClient.convertToType(data['respOrgName'], 'String');
            }
            if (data.hasOwnProperty('troubleReqNum')) {
                obj['troubleReqNum'] = ApiClient.convertToType(data['troubleReqNum'], 'String');
            }
    ...
    /**
    * @member {String} dialNum
    */
    dialNum = undefined;
    /**
    * @member {String} respOrgQueried
    */
    respOrgQueried = undefined;
    /**
    * @member {String} respOrgName
    */
    respOrgName = undefined;
    /**
    * @member {String} troubleReqNum
    */
    troubleReqNum = undefined;
    /**
