...
/**
* The TempList model module.
* @module model/TempList
* @version v1
*/
export default class TempList {
    /**
    * Constructs a new <code>TempList</code>.
    * @alias module:model/TempList
    * @class
    */
    ...
    /**
    * Constructs a <code>TempList</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/TempList} obj Optional instance to populate.
    * @return {module:model/TempList} The populated <code>TempList</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TempList();
            ...
            if (data.hasOwnProperty('descrip')) {
                obj['descrip'] = ApiClient.convertToType(data['descrip'], 'String');
            }
        }
        return obj;
    }
