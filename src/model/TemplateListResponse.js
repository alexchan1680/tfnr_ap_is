...
* @version v1
*/
export default class TemplateListResponse {
    /**
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('tempEntRecId')) {
                obj['tempEntRecId'] = ApiClient.convertToType(data['tempEntRecId'], 'String');
            }
            if (data.hasOwnProperty('startTempName')) {
                obj['startTempName'] = ApiClient.convertToType(data['startTempName'], 'String');
            }
            if (data.hasOwnProperty('tempList')) {
                obj['tempList'] = ApiClient.convertToType(data['tempList'], [TempList]);
            }
    ...
    /**
    * Entity that controls the Template records. Entity ID for which the list of Template records will be returned.
    * @member {String} tempEntRecId
    */
    tempEntRecId = undefined;
    /**
    * Starting Template Name
    * @member {String} startTempName
    */
    startTempName = undefined;
    /**
    * Template List
    * @member {Array.<module:model/TempList>} tempList
    */
    tempList = undefined;
    /**
