...
import CustomerRecordQueryResponseEffDtTmList from './CustomerRecordQueryResponseEffDtTmList';
...
/**
* The TemplateRecordQueryResponse model module.
* @module model/TemplateRecordQueryResponse
* @version v1
*/
export default class TemplateRecordQueryResponse {
    /**
    * Constructs a new <code>TemplateRecordQueryResponse</code>.
    * @alias module:model/TemplateRecordQueryResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>TemplateRecordQueryResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/TemplateRecordQueryResponse} obj Optional instance to populate.
    * @return {module:model/TemplateRecordQueryResponse} The populated <code>TemplateRecordQueryResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TemplateRecordQueryResponse();

            
            
            

            if (data.hasOwnProperty('ctlRespOrgId')) {
                obj['ctlRespOrgId'] = ApiClient.convertToType(data['ctlRespOrgId'], 'String');
            }
            if (data.hasOwnProperty('custRecPerms')) {
                obj['custRecPerms'] = ApiClient.convertToType(data['custRecPerms'], 'String');
            }
            if (data.hasOwnProperty('effDtTmList')) {
                obj['effDtTmList'] = ApiClient.convertToType(data['effDtTmList'], [CustomerRecordQueryResponseEffDtTmList]);
            }
    ...
    /**
    * @member {String} ctlRespOrgId
    */
    ctlRespOrgId = undefined;
    /**
    * @member {String} custRecPerms
    */
    custRecPerms = undefined;
    /**
    * @member {Array.<module:model/CustomerRecordQueryResponseEffDtTmList>} effDtTmList
    */
    effDtTmList = undefined;
    /**
