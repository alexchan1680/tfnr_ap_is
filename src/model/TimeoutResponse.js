...
/**
* The TimeoutResponse model module.
* @module model/TimeoutResponse
* @version v1
*/
export default class TimeoutResponse {
    /**
    * Constructs a new <code>TimeoutResponse</code>.
    * @alias module:model/TimeoutResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>TimeoutResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/TimeoutResponse} obj Optional instance to populate.
    * @return {module:model/TimeoutResponse} The populated <code>TimeoutResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TimeoutResponse();
    ...
    /**
    * RequestId returned due to timeout
    ...
    */
    blkId = undefined;
    /**
    * Status message is returned during polling
