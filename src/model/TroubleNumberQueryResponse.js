...
import TRQResult from './TRQResult';
...
/**
* The TroubleNumberQueryResponse model module.
* @module model/TroubleNumberQueryResponse
* @version v1
*/
export default class TroubleNumberQueryResponse {
    /**
    * Constructs a new <code>TroubleNumberQueryResponse</code>.
    * @alias module:model/TroubleNumberQueryResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>TroubleNumberQueryResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/TroubleNumberQueryResponse} obj Optional instance to populate.
    * @return {module:model/TroubleNumberQueryResponse} The populated <code>TroubleNumberQueryResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TroubleNumberQueryResponse();

            
            
            

            if (data.hasOwnProperty('TRQResult')) {
                obj['TRQResult'] = ApiClient.convertToType(data['TRQResult'], [TRQResult]);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {Array.<module:model/TRQResult>} TRQResult
    */
    TRQResult = undefined;
