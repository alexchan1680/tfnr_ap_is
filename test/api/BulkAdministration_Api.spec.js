...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.BulkAdministration_Api();
  });
  ...
  describe('BulkAdministration_Api', function() {
    describe('bulkCount', function() {
      it('should call bulkCount successfully', function(done) {
        //uncomment below and update the code to test bulkCount
        //instance.bulkCount(function(error) {
    ...
    describe('bulkCountbyRequestId', function() {
      it('should call bulkCountbyRequestId successfully', function(done) {
        //uncomment below and update the code to test bulkCountbyRequestId
        //instance.bulkCountbyRequestId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('bulkDeletebyRequestId', function() {
      it('should call bulkDeletebyRequestId successfully', function(done) {
        //uncomment below and update the code to test bulkDeletebyRequestId
        //instance.bulkDeletebyRequestId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('bulkList', function() {
      it('should call bulkList successfully', function(done) {
        //uncomment below and update the code to test bulkList
        //instance.bulkList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('bulkListSyncTimeout', function() {
      it('should call bulkListSyncTimeout successfully', function(done) {
        //uncomment below and update the code to test bulkListSyncTimeout
        //instance.bulkListSyncTimeout(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
