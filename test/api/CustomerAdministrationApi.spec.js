...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.CustomerAdministrationApi();
  });
  ...
  describe('CustomerAdministrationApi', function() {
    describe('customerUnlock', function() {
      it('should call customerUnlock successfully', function(done) {
        //uncomment below and update the code to test customerUnlock
        //instance.customerUnlock(function(error) {
    ...
    describe('customerUnlockByRequestId', function() {
      it('should call customerUnlockByRequestId successfully', function(done) {
        //uncomment below and update the code to test customerUnlockByRequestId
        //instance.customerUnlockByRequestId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
