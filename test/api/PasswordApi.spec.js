...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.PasswordApi();
  });
  ...
  describe('PasswordApi', function() {
    describe('passwordForgot', function() {
      it('should call passwordForgot successfully', function(done) {
        //uncomment below and update the code to test passwordForgot
        //instance.passwordForgot(function(error) {
    ...
    describe('passwordForgotbyRequestId', function() {
      it('should call passwordForgotbyRequestId successfully', function(done) {
        //uncomment below and update the code to test passwordForgotbyRequestId
        //instance.passwordForgotbyRequestId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('passwordResetbyRequestId', function() {
      it('should call passwordResetbyRequestId successfully', function(done) {
        //uncomment below and update the code to test passwordResetbyRequestId
        //instance.passwordResetbyRequestId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('passwordUpdate', function() {
      it('should call passwordUpdate successfully', function(done) {
        //uncomment below and update the code to test passwordUpdate
        //instance.passwordUpdate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('passwordUpdateByRequestId', function() {
      it('should call passwordUpdateByRequestId successfully', function(done) {
        //uncomment below and update the code to test passwordUpdateByRequestId
        //instance.passwordUpdateByRequestId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
