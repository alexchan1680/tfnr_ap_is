...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.SCPStatusNumberAdministration_Api();
  });
  ...
  describe('SCPStatusNumberAdministration_Api', function() {
    describe('sCPStatusNumberDeletebyRequestId', function() {
      it('should call sCPStatusNumberDeletebyRequestId successfully', function(done) {
        //uncomment below and update the code to test sCPStatusNumberDeletebyRequestId
        //instance.sCPStatusNumberDeletebyRequestId(function(error) {
    ...
    describe('scpStatusNumberAudit', function() {
      it('should call scpStatusNumberAudit successfully', function(done) {
        //uncomment below and update the code to test scpStatusNumberAudit
        //instance.scpStatusNumberAudit(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('scpStatusNumberAuditbyRequestId', function() {
      it('should call scpStatusNumberAuditbyRequestId successfully', function(done) {
        //uncomment below and update the code to test scpStatusNumberAuditbyRequestId
        //instance.scpStatusNumberAuditbyRequestId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('scpStatusNumberDelete', function() {
      it('should call scpStatusNumberDelete successfully', function(done) {
        //uncomment below and update the code to test scpStatusNumberDelete
        //instance.scpStatusNumberDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('scpStatusNumberQuery', function() {
      it('should call scpStatusNumberQuery successfully', function(done) {
        //uncomment below and update the code to test scpStatusNumberQuery
        //instance.scpStatusNumberQuery(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('scpStatusNumberQuerybyRequestId', function() {
      it('should call scpStatusNumberQuerybyRequestId successfully', function(done) {
        //uncomment below and update the code to test scpStatusNumberQuerybyRequestId
        //instance.scpStatusNumberQuerybyRequestId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('scpStatusNumberResend', function() {
      it('should call scpStatusNumberResend successfully', function(done) {
        //uncomment below and update the code to test scpStatusNumberResend
        //instance.scpStatusNumberResend(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('scpStatusNumberResendbyRequestId', function() {
      it('should call scpStatusNumberResendbyRequestId successfully', function(done) {
        //uncomment below and update the code to test scpStatusNumberResendbyRequestId
        //instance.scpStatusNumberResendbyRequestId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
