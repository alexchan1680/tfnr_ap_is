...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.SessionApi();
  });
  ...
  describe('SessionApi', function() {
    describe('sessionClose', function() {
      it('should call sessionClose successfully', function(done) {
        //uncomment below and update the code to test sessionClose
        //instance.sessionClose(function(error) {
    ...
    describe('sessionOpen', function() {
      it('should call sessionOpen successfully', function(done) {
        //uncomment below and update the code to test sessionOpen
        //instance.sessionOpen(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
