...
(function(root, factory) {
  ...
  describe('Aos', function() {
    it('should create an instance of Aos', function() {
      // uncomment below and update the code to test Aos
      //var instane = new TfnrApIs.Aos();
      //expect(instance).to.be.a(TfnrApIs.Aos);
    });

    it('should have the property aosLbl (base name: "aosLbl")', function() {
      // uncomment below and update the code to test the property aosLbl
      //var instane = new TfnrApIs.Aos();
      //expect(instance).to.be();
    });

    it('should have the property aosAC (base name: "aosAC")', function() {
      // uncomment below and update the code to test the property aosAC
      //var instane = new TfnrApIs.Aos();
      //expect(instance).to.be();
    });

    it('should have the property aosLATA (base name: "aosLATA")', function() {
      // uncomment below and update the code to test the property aosLATA
      //var instane = new TfnrApIs.Aos();
      //expect(instance).to.be();
    });

    it('should have the property aosNet (base name: "aosNet")', function() {
      // uncomment below and update the code to test the property aosNet
      //var instane = new TfnrApIs.Aos();
      //expect(instance).to.be();
    });

    it('should have the property aosState (base name: "aosState")', function() {
      // uncomment below and update the code to test the property aosState
      //var instane = new TfnrApIs.Aos();
      //expect(instance).to.be();
    });
