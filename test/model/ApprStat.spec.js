...
(function(root, factory) {
  ...
  describe('ApprStat', function() {
    it('should create an instance of ApprStat', function() {
      // uncomment below and update the code to test ApprStat
      //var instane = new TfnrApIs.ApprStat();
      //expect(instance).to.be.a(TfnrApIs.ApprStat);
    });
