...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.AuditStatusNumberRequest();
  });
  ...
  describe('AuditStatusNumberRequest', function() {
    it('should create an instance of AuditStatusNumberRequest', function() {
      // uncomment below and update the code to test AuditStatusNumberRequest
      //var instane = new TfnrApIs.AuditStatusNumberRequest();
      //expect(instance).to.be.a(TfnrApIs.AuditStatusNumberRequest);
    });
    ...
    it('should have the property critInd (base name: "critInd")', function() {
      // uncomment below and update the code to test the property critInd
      //var instane = new TfnrApIs.AuditStatusNumberRequest();
      //expect(instance).to.be();
    });
