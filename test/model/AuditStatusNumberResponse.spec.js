...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.AuditStatusNumberResponse();
  });
  ...
  describe('AuditStatusNumberResponse', function() {
    it('should create an instance of AuditStatusNumberResponse', function() {
      // uncomment below and update the code to test AuditStatusNumberResponse
      //var instane = new TfnrApIs.AuditStatusNumberResponse();
      //expect(instance).to.be.a(TfnrApIs.AuditStatusNumberResponse);
    });

    it('should have the property recNum (base name: "recNum")', function() {
      // uncomment below and update the code to test the property recNum
      //var instane = new TfnrApIs.AuditStatusNumberResponse();
      //expect(instance).to.be();
    });

    it('should have the property recStat (base name: "recStat")', function() {
      // uncomment below and update the code to test the property recStat
      //var instane = new TfnrApIs.AuditStatusNumberResponse();
      //expect(instance).to.be();
    });

    it('should have the property scpRecs (base name: "scpRecs")', function() {
      // uncomment below and update the code to test the property scpRecs
      //var instane = new TfnrApIs.AuditStatusNumberResponse();
      //expect(instance).to.be();
    });
