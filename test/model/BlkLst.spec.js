...
(function(root, factory) {
  ...
  describe('BlkLst', function() {
    it('should create an instance of BlkLst', function() {
      // uncomment below and update the code to test BlkLst
      //var instane = new TfnrApIs.BlkLst();
      //expect(instance).to.be.a(TfnrApIs.BlkLst);
    });
    ...
    it('should have the property crDt (base name: "crDt")', function() {
      // uncomment below and update the code to test the property crDt
      //var instane = new TfnrApIs.BlkLst();
      //expect(instance).to.be();
    });

    it('should have the property cmplDt (base name: "cmplDt")', function() {
      // uncomment below and update the code to test the property cmplDt
      //var instane = new TfnrApIs.BlkLst();
      //expect(instance).to.be();
    });

    it('should have the property usrId (base name: "usrId")', function() {
      // uncomment below and update the code to test the property usrId
      //var instane = new TfnrApIs.BlkLst();
      //expect(instance).to.be();
    });

    it('should have the property reqType (base name: "reqType")', function() {
      // uncomment below and update the code to test the property reqType
      //var instane = new TfnrApIs.BlkLst();
      //expect(instance).to.be();
    });

    it('should have the property blkId (base name: "blkId")', function() {
      // uncomment below and update the code to test the property blkId
      //var instane = new TfnrApIs.BlkLst();
      //expect(instance).to.be();
    });
