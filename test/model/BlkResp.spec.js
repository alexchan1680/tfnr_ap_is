...
(function(root, factory) {
  ...
  describe('BlkResp', function() {
    it('should create an instance of BlkResp', function() {
      // uncomment below and update the code to test BlkResp
      //var instane = new TfnrApIs.BlkResp();
      //expect(instance).to.be.a(TfnrApIs.BlkResp);
    });

    it('should have the property tfNum (base name: "tfNum")', function() {
      // uncomment below and update the code to test the property tfNum
      //var instane = new TfnrApIs.BlkResp();
    ...
    it('should have the property timeOutResp (base name: "timeOutResp")', function() {
      // uncomment below and update the code to test the property timeOutResp
      //var instane = new TfnrApIs.BlkResp();
      //expect(instance).to.be();
    });
