...
(function(root, factory) {
  ...
  describe('BoolYN', function() {
    it('should create an instance of BoolYN', function() {
      // uncomment below and update the code to test BoolYN
      //var instane = new TfnrApIs.BoolYN();
      //expect(instance).to.be.a(TfnrApIs.BoolYN);
    });
