...
(function(root, factory) {
  ...
  describe('BoolYNExt', function() {
    it('should create an instance of BoolYNExt', function() {
      // uncomment below and update the code to test BoolYNExt
      //var instane = new TfnrApIs.BoolYNExt();
      //expect(instance).to.be.a(TfnrApIs.BoolYNExt);
    });
