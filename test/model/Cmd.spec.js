...
(function(root, factory) {
  ...
  describe('Cmd', function() {
    it('should create an instance of Cmd', function() {
      // uncomment below and update the code to test Cmd
      //var instane = new TfnrApIs.Cmd();
      //expect(instance).to.be.a(TfnrApIs.Cmd);
    });
