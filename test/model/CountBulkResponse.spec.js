...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.CountBulkResponse();
  });
  ...
  describe('CountBulkResponse', function() {
    it('should create an instance of CountBulkResponse', function() {
      // uncomment below and update the code to test CountBulkResponse
      //var instane = new TfnrApIs.CountBulkResponse();
      //expect(instance).to.be.a(TfnrApIs.CountBulkResponse);
    });

    it('should have the property blkReqCount (base name: "blkReqCount")', function() {
      // uncomment below and update the code to test the property blkReqCount
      //var instane = new TfnrApIs.CountBulkResponse();
