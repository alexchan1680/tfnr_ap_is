...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.CprSectName();
  });
  ...
  describe('CprSectName', function() {
    it('should create an instance of CprSectName', function() {
      // uncomment below and update the code to test CprSectName
      //var instane = new TfnrApIs.CprSectName();
      //expect(instance).to.be.a(TfnrApIs.CprSectName);
    });
    ...
    it('should have the property nodeSeq (base name: "nodeSeq")', function() {
      // uncomment below and update the code to test the property nodeSeq
      //var instane = new TfnrApIs.CprSectName();
      //expect(instance).to.be();
    });
