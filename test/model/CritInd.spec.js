...
(function(root, factory) {
  ...
  describe('CritInd', function() {
    it('should create an instance of CritInd', function() {
      // uncomment below and update the code to test CritInd
      //var instane = new TfnrApIs.CritInd();
      //expect(instance).to.be.a(TfnrApIs.CritInd);
    });
