...
(function(root, factory) {
  ...
  describe('CustRecCompPart', function() {
    it('should create an instance of CustRecCompPart', function() {
      // uncomment below and update the code to test CustRecCompPart
      //var instane = new TfnrApIs.CustRecCompPart();
      //expect(instance).to.be.a(TfnrApIs.CustRecCompPart);
    });
