...
(function(root, factory) {
  ...
  describe('CustRecStat', function() {
    it('should create an instance of CustRecStat', function() {
      // uncomment below and update the code to test CustRecStat
      //var instane = new TfnrApIs.CustRecStat();
      //expect(instance).to.be.a(TfnrApIs.CustRecStat);
    });
