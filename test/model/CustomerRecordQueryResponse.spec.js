...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.CustomerRecordQueryResponse();
  });
  ...
  describe('CustomerRecordQueryResponse', function() {
    it('should create an instance of CustomerRecordQueryResponse', function() {
      // uncomment below and update the code to test CustomerRecordQueryResponse
      //var instane = new TfnrApIs.CustomerRecordQueryResponse();
      //expect(instance).to.be.a(TfnrApIs.CustomerRecordQueryResponse);
    });
