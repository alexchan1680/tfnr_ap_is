...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.CustomerRecordQueryResponseEffDtTmList();
  });
  ...
  describe('CustomerRecordQueryResponseEffDtTmList', function() {
    it('should create an instance of CustomerRecordQueryResponseEffDtTmList', function() {
      // uncomment below and update the code to test CustomerRecordQueryResponseEffDtTmList
      //var instane = new TfnrApIs.CustomerRecordQueryResponseEffDtTmList();
      //expect(instance).to.be.a(TfnrApIs.CustomerRecordQueryResponseEffDtTmList);
    });
    ...
    it('should have the property custRecOrderType (base name: "custRecOrderType")', function() {
      // uncomment below and update the code to test the property custRecOrderType
      //var instane = new TfnrApIs.CustomerRecordQueryResponseEffDtTmList();
      //expect(instance).to.be();
    });
