...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.CustomerUnlockRequest();
  });
  ...
  describe('CustomerUnlockRequest', function() {
    it('should create an instance of CustomerUnlockRequest', function() {
      // uncomment below and update the code to test CustomerUnlockRequest
      //var instane = new TfnrApIs.CustomerUnlockRequest();
      //expect(instance).to.be.a(TfnrApIs.CustomerUnlockRequest);
    });
    ...
    it('should have the property costCauserFlag (base name: "costCauserFlag")', function() {
      // uncomment below and update the code to test the property costCauserFlag
      //var instane = new TfnrApIs.CustomerUnlockRequest();
      //expect(instance).to.be();
    });
