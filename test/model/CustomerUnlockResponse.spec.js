...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.CustomerUnlockResponse();
  });
  ...
  describe('CustomerUnlockResponse', function() {
    it('should create an instance of CustomerUnlockResponse', function() {
      // uncomment below and update the code to test CustomerUnlockResponse
      //var instane = new TfnrApIs.CustomerUnlockResponse();
      //expect(instance).to.be.a(TfnrApIs.CustomerUnlockResponse);
    });
