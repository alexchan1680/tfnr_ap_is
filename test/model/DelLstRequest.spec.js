...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.DelLstRequest();
  });
  ...
  describe('DelLstRequest', function() {
    it('should create an instance of DelLstRequest', function() {
      // uncomment below and update the code to test DelLstRequest
      //var instane = new TfnrApIs.DelLstRequest();
      //expect(instance).to.be.a(TfnrApIs.DelLstRequest);
    });
    ...
    it('should have the property reqStatus (base name: "reqStatus")', function() {
      // uncomment below and update the code to test the property reqStatus
      //var instane = new TfnrApIs.DelLstRequest();
      //expect(instance).to.be();
    });
