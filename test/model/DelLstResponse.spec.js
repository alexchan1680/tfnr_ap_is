...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.DelLstResponse();
  });
  ...
  describe('DelLstResponse', function() {
    it('should create an instance of DelLstResponse', function() {
      // uncomment below and update the code to test DelLstResponse
      //var instane = new TfnrApIs.DelLstResponse();
      //expect(instance).to.be.a(TfnrApIs.DelLstResponse);
    });
    ...
    it('should have the property delStatus (base name: "delStatus")', function() {
      // uncomment below and update the code to test the property delStatus
      //var instane = new TfnrApIs.DelLstResponse();
      //expect(instance).to.be();
    });
