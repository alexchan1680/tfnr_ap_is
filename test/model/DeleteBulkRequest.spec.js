...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.DeleteBulkRequest();
  });
  ...
  describe('DeleteBulkRequest', function() {
    it('should create an instance of DeleteBulkRequest', function() {
      // uncomment below and update the code to test DeleteBulkRequest
      //var instane = new TfnrApIs.DeleteBulkRequest();
      //expect(instance).to.be.a(TfnrApIs.DeleteBulkRequest);
    });
