...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.DeleteBulkResponse();
  });
  ...
  describe('DeleteBulkResponse', function() {
    it('should create an instance of DeleteBulkResponse', function() {
      // uncomment below and update the code to test DeleteBulkResponse
      //var instane = new TfnrApIs.DeleteBulkResponse();
      //expect(instance).to.be.a(TfnrApIs.DeleteBulkResponse);
    });

    it('should have the property delLst (base name: "delLst")', function() {
      // uncomment below and update the code to test the property delLst
      //var instane = new TfnrApIs.DeleteBulkResponse();
