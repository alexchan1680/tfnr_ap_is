...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.DeleteNumberResponse();
  });
  ...
  describe('DeleteNumberResponse', function() {
    it('should create an instance of DeleteNumberResponse', function() {
      // uncomment below and update the code to test DeleteNumberResponse
      //var instane = new TfnrApIs.DeleteNumberResponse();
      //expect(instance).to.be.a(TfnrApIs.DeleteNumberResponse);
    });
