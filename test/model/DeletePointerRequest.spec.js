...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.DeletePointerRequest();
  });
  ...
  describe('DeletePointerRequest', function() {
    it('should create an instance of DeletePointerRequest', function() {
      // uncomment below and update the code to test DeletePointerRequest
      //var instane = new TfnrApIs.DeletePointerRequest();
      //expect(instance).to.be.a(TfnrApIs.DeletePointerRequest);
    });
