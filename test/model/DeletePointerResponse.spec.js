...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.DeletePointerResponse();
  });
  ...
  describe('DeletePointerResponse', function() {
    it('should create an instance of DeletePointerResponse', function() {
      // uncomment below and update the code to test DeletePointerResponse
      //var instane = new TfnrApIs.DeletePointerResponse();
      //expect(instance).to.be.a(TfnrApIs.DeletePointerResponse);
    });
