...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.DestNums();
  });
  ...
  describe('DestNums', function() {
    it('should create an instance of DestNums', function() {
      // uncomment below and update the code to test DestNums
      //var instane = new TfnrApIs.DestNums();
      //expect(instance).to.be.a(TfnrApIs.DestNums);
    });

    it('should have the property destNum (base name: "destNum")', function() {
      // uncomment below and update the code to test the property destNum
      //var instane = new TfnrApIs.DestNums();
    ...
    it('should have the property forSrvOff (base name: "forSrvOff")', function() {
      // uncomment below and update the code to test the property forSrvOff
      //var instane = new TfnrApIs.DestNums();
      //expect(instance).to.be();
    });

    it('should have the property localServOff (base name: "localServOff")', function() {
      // uncomment below and update the code to test the property localServOff
      //var instane = new TfnrApIs.DestNums();
      //expect(instance).to.be();
    });
