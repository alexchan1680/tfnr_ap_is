...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.DisconnectCustomerRequest();
  });
  ...
  describe('DisconnectCustomerRequest', function() {
    it('should create an instance of DisconnectCustomerRequest', function() {
      // uncomment below and update the code to test DisconnectCustomerRequest
      //var instane = new TfnrApIs.DisconnectCustomerRequest();
      //expect(instance).to.be.a(TfnrApIs.DisconnectCustomerRequest);
    });
