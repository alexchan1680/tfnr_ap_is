...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.DisconnectCustomerResponse();
  });
  ...
  describe('DisconnectCustomerResponse', function() {
    it('should create an instance of DisconnectCustomerResponse', function() {
      // uncomment below and update the code to test DisconnectCustomerResponse
      //var instane = new TfnrApIs.DisconnectCustomerResponse();
      //expect(instance).to.be.a(TfnrApIs.DisconnectCustomerResponse);
    });
    ...
    it('should have the property custRecEntity (base name: "custRecEntity")', function() {
      // uncomment below and update the code to test the property custRecEntity
      //var instane = new TfnrApIs.DisconnectCustomerResponse();
      //expect(instance).to.be();
    });
