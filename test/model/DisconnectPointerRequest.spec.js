...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.DisconnectPointerRequest();
  });
  ...
  describe('DisconnectPointerRequest', function() {
    it('should create an instance of DisconnectPointerRequest', function() {
      // uncomment below and update the code to test DisconnectPointerRequest
      //var instane = new TfnrApIs.DisconnectPointerRequest();
      //expect(instance).to.be.a(TfnrApIs.DisconnectPointerRequest);
    });
