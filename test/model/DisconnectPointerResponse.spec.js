...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.DisconnectPointerResponse();
  });
  ...
  describe('DisconnectPointerResponse', function() {
    it('should create an instance of DisconnectPointerResponse', function() {
      // uncomment below and update the code to test DisconnectPointerResponse
      //var instane = new TfnrApIs.DisconnectPointerResponse();
      //expect(instance).to.be.a(TfnrApIs.DisconnectPointerResponse);
    });
    ...
    it('should have the property lstEffDtTm (base name: "lstEffDtTm")', function() {
      // uncomment below and update the code to test the property lstEffDtTm
      //var instane = new TfnrApIs.DisconnectPointerResponse();
      //expect(instance).to.be();
    });
