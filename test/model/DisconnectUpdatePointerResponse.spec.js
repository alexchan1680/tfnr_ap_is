...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.DisconnectUpdatePointerResponse();
  });
  ...
  describe('DisconnectUpdatePointerResponse', function() {
    it('should create an instance of DisconnectUpdatePointerResponse', function() {
      // uncomment below and update the code to test DisconnectUpdatePointerResponse
      //var instane = new TfnrApIs.DisconnectUpdatePointerResponse();
      //expect(instance).to.be.a(TfnrApIs.DisconnectUpdatePointerResponse);
    });
