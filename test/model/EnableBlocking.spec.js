...
(function(root, factory) {
  ...
  describe('EnableBlocking', function() {
    it('should create an instance of EnableBlocking', function() {
      // uncomment below and update the code to test EnableBlocking
      //var instane = new TfnrApIs.EnableBlocking();
      //expect(instance).to.be.a(TfnrApIs.EnableBlocking);
    });
