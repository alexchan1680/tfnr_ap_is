...
(function(root, factory) {
  ...
  describe('Err', function() {
    it('should create an instance of Err', function() {
      ...
      //var instane = new TfnrApIs.Err();
      //expect(instance).to.be.a(TfnrApIs.Err);
    });
    ...
    it('should have the property errLvl (base name: "errLvl")', function() {
      // uncomment below and update the code to test the property errLvl
      //var instane = new TfnrApIs.Err();
      //expect(instance).to.be();
    });
