...
(function(root, factory) {
  ...
  describe('ErrList', function() {
    it('should create an instance of ErrList', function() {
      // uncomment below and update the code to test ErrList
      //var instane = new TfnrApIs.ErrList();
      //expect(instance).to.be.a(TfnrApIs.ErrList);
    });
