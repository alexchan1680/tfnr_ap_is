...
(function(root, factory) {
  ...
  describe('ErrLvl', function() {
    it('should create an instance of ErrLvl', function() {
      // uncomment below and update the code to test ErrLvl
      //var instane = new TfnrApIs.ErrLvl();
      //expect(instance).to.be.a(TfnrApIs.ErrLvl);
    });
