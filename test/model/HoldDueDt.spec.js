...
(function(root, factory) {
  ...
  describe('HoldDueDt', function() {
    it('should create an instance of HoldDueDt', function() {
      // uncomment below and update the code to test HoldDueDt
      //var instane = new TfnrApIs.HoldDueDt();
      //expect(instance).to.be.a(TfnrApIs.HoldDueDt);
    });
