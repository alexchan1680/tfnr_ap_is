...
(function(root, factory) {
  ...
  describe('Lbl', function() {
    it('should create an instance of Lbl', function() {
      // uncomment below and update the code to test Lbl
      //var instane = new TfnrApIs.Lbl();
      //expect(instance).to.be.a(TfnrApIs.Lbl);
    });

    it('should have the property lblType (base name: "lblType")', function() {
      // uncomment below and update the code to test the property lblType
      //var instane = new TfnrApIs.Lbl();
      //expect(instance).to.be();
    });

    it('should have the property lblName (base name: "lblName")', function() {
      // uncomment below and update the code to test the property lblName
      //var instane = new TfnrApIs.Lbl();
      //expect(instance).to.be();
    });

    it('should have the property lblVals (base name: "lblVals")', function() {
      // uncomment below and update the code to test the property lblVals
      //var instane = new TfnrApIs.Lbl();
      //expect(instance).to.be();
    });
