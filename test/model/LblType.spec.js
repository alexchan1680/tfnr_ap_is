...
(function(root, factory) {
  ...
  describe('LblType', function() {
    it('should create an instance of LblType', function() {
      // uncomment below and update the code to test LblType
      //var instane = new TfnrApIs.LblType();
      //expect(instance).to.be.a(TfnrApIs.LblType);
    });
