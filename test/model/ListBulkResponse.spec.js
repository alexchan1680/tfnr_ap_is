...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.ListBulkResponse();
  });
  ...
  describe('ListBulkResponse', function() {
    it('should create an instance of ListBulkResponse', function() {
      // uncomment below and update the code to test ListBulkResponse
      //var instane = new TfnrApIs.ListBulkResponse();
      //expect(instance).to.be.a(TfnrApIs.ListBulkResponse);
    });

    it('should have the property blkLst (base name: "blkLst")', function() {
      // uncomment below and update the code to test the property blkLst
      //var instane = new TfnrApIs.ListBulkResponse();
