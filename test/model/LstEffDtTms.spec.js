...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.LstEffDtTms();
  });
  ...
  describe('LstEffDtTms', function() {
    it('should create an instance of LstEffDtTms', function() {
      // uncomment below and update the code to test LstEffDtTms
      //var instane = new TfnrApIs.LstEffDtTms();
      //expect(instance).to.be.a(TfnrApIs.LstEffDtTms);
    });
