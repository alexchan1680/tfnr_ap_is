...
(function(root, factory) {
  ...
  describe('Npa', function() {
    it('should create an instance of Npa', function() {
      // uncomment below and update the code to test Npa
      //var instane = new TfnrApIs.Npa();
      //expect(instance).to.be.a(TfnrApIs.Npa);
    });
