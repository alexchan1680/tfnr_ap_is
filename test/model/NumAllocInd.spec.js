...
(function(root, factory) {
  ...
  describe('NumAllocInd', function() {
    it('should create an instance of NumAllocInd', function() {
      // uncomment below and update the code to test NumAllocInd
      //var instane = new TfnrApIs.NumAllocInd();
      //expect(instance).to.be.a(TfnrApIs.NumAllocInd);
    });
