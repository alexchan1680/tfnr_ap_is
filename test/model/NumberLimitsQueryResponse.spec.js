...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.NumberLimitsQueryResponse();
  });
  ...
  describe('NumberLimitsQueryResponse', function() {
    it('should create an instance of NumberLimitsQueryResponse', function() {
      // uncomment below and update the code to test NumberLimitsQueryResponse
      //var instane = new TfnrApIs.NumberLimitsQueryResponse();
      //expect(instance).to.be.a(TfnrApIs.NumberLimitsQueryResponse);
    });

    it('should have the property lastUpdateDtTm (base name: "lastUpdateDtTm")', function() {
      // uncomment below and update the code to test the property lastUpdateDtTm
      //var instane = new TfnrApIs.NumberLimitsQueryResponse();
      //expect(instance).to.be();
    });

    it('should have the property pctWorkNums (base name: "pctWorkNums")', function() {
      // uncomment below and update the code to test the property pctWorkNums
      //var instane = new TfnrApIs.NumberLimitsQueryResponse();
      //expect(instance).to.be();
    });

    it('should have the property numResLimit (base name: "numResLimit")', function() {
      // uncomment below and update the code to test the property numResLimit
      //var instane = new TfnrApIs.NumberLimitsQueryResponse();
      //expect(instance).to.be();
    });

    it('should have the property enableBlocking (base name: "enableBlocking")', function() {
      // uncomment below and update the code to test the property enableBlocking
      //var instane = new TfnrApIs.NumberLimitsQueryResponse();
      //expect(instance).to.be();
    });

    it('should have the property resTimeMins (base name: "resTimeMins")', function() {
      // uncomment below and update the code to test the property resTimeMins
      //var instane = new TfnrApIs.NumberLimitsQueryResponse();
      //expect(instance).to.be();
    });

    it('should have the property extLockoutMins (base name: "extLockoutMins")', function() {
      // uncomment below and update the code to test the property extLockoutMins
      //var instane = new TfnrApIs.NumberLimitsQueryResponse();
      //expect(instance).to.be();
    });

    it('should have the property lockoutCleanup (base name: "lockoutCleanup")', function() {
      // uncomment below and update the code to test the property lockoutCleanup
      //var instane = new TfnrApIs.NumberLimitsQueryResponse();
      //expect(instance).to.be();
    });

    it('should have the property numAllocInd (base name: "numAllocInd")', function() {
      // uncomment below and update the code to test the property numAllocInd
      //var instane = new TfnrApIs.NumberLimitsQueryResponse();
      //expect(instance).to.be();
    });

    it('should have the property pctSpareLimit (base name: "pctSpareLimit")', function() {
      // uncomment below and update the code to test the property pctSpareLimit
      //var instane = new TfnrApIs.NumberLimitsQueryResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property maxResLimit (base name: "maxResLimit")', function() {
      // uncomment below and update the code to test the property maxResLimit
      //var instane = new TfnrApIs.NumberLimitsQueryResponse();
      //expect(instance).to.be();
    });

    it('should have the property resNumCnt (base name: "resNumCnt")', function() {
      // uncomment below and update the code to test the property resNumCnt
      //var instane = new TfnrApIs.NumberLimitsQueryResponse();
      //expect(instance).to.be();
    });

    it('should have the property workingNumCnt (base name: "workingNumCnt")', function() {
      // uncomment below and update the code to test the property workingNumCnt
      //var instane = new TfnrApIs.NumberLimitsQueryResponse();
      //expect(instance).to.be();
    });

    it('should have the property remainingRes (base name: "remainingRes")', function() {
      // uncomment below and update the code to test the property remainingRes
      //var instane = new TfnrApIs.NumberLimitsQueryResponse();
      //expect(instance).to.be();
    });

    it('should have the property dtTmRefreshed (base name: "dtTmRefreshed")', function() {
      // uncomment below and update the code to test the property dtTmRefreshed
      //var instane = new TfnrApIs.NumberLimitsQueryResponse();
      //expect(instance).to.be();
    });

    it('should have the property dtLastUpdated (base name: "dtLastUpdated")', function() {
      // uncomment below and update the code to test the property dtLastUpdated
      //var instane = new TfnrApIs.NumberLimitsQueryResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property transToSpareTm (base name: "transToSpareTm")', function() {
      // uncomment below and update the code to test the property transToSpareTm
      //var instane = new TfnrApIs.NumberLimitsQueryResponse();
      //expect(instance).to.be();
    });

    it('should have the property resToSpareTm (base name: "resToSpareTm")', function() {
      // uncomment below and update the code to test the property resToSpareTm
      //var instane = new TfnrApIs.NumberLimitsQueryResponse();
      //expect(instance).to.be();
    });

    it('should have the property transToSpareFlag (base name: "transToSpareFlag")', function() {
      // uncomment below and update the code to test the property transToSpareFlag
      //var instane = new TfnrApIs.NumberLimitsQueryResponse();
      //expect(instance).to.be();
    });

    it('should have the property resToSpareFlag (base name: "resToSpareFlag")', function() {
      // uncomment below and update the code to test the property resToSpareFlag
      //var instane = new TfnrApIs.NumberLimitsQueryResponse();
      //expect(instance).to.be();
    });
