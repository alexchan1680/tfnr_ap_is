...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.NumberQueryResponse();
  });
  ...
  describe('NumberQueryResponse', function() {
    it('should create an instance of NumberQueryResponse', function() {
      // uncomment below and update the code to test NumberQueryResponse
      //var instane = new TfnrApIs.NumberQueryResponse();
      //expect(instance).to.be.a(TfnrApIs.NumberQueryResponse);
    });

    it('should have the property lastActDt (base name: "lastActDt")', function() {
      // uncomment below and update the code to test the property lastActDt
      //var instane = new TfnrApIs.NumberQueryResponse();
      //expect(instance).to.be();
    });

    it('should have the property resUntilDt (base name: "resUntilDt")', function() {
      // uncomment below and update the code to test the property resUntilDt
      //var instane = new TfnrApIs.NumberQueryResponse();
      //expect(instance).to.be();
    });

    it('should have the property discUntilDt (base name: "discUntilDt")', function() {
      // uncomment below and update the code to test the property discUntilDt
      //var instane = new TfnrApIs.NumberQueryResponse();
      //expect(instance).to.be();
    });

    it('should have the property effDt (base name: "effDt")', function() {
      // uncomment below and update the code to test the property effDt
      //var instane = new TfnrApIs.NumberQueryResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property ctlRespOrg (base name: "ctlRespOrg")', function() {
      // uncomment below and update the code to test the property ctlRespOrg
      //var instane = new TfnrApIs.NumberQueryResponse();
      //expect(instance).to.be();
    });
