...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.NumberSearchRequest();
  });
  ...
  describe('NumberSearchRequest', function() {
    it('should create an instance of NumberSearchRequest', function() {
      // uncomment below and update the code to test NumberSearchRequest
      //var instane = new TfnrApIs.NumberSearchRequest();
      //expect(instance).to.be.a(TfnrApIs.NumberSearchRequest);
    });
