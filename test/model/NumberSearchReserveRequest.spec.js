...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.NumberSearchReserveRequest();
  });
  ...
  describe('NumberSearchReserveRequest', function() {
    it('should create an instance of NumberSearchReserveRequest', function() {
      // uncomment below and update the code to test NumberSearchReserveRequest
      //var instane = new TfnrApIs.NumberSearchReserveRequest();
      //expect(instance).to.be.a(TfnrApIs.NumberSearchReserveRequest);
    });
