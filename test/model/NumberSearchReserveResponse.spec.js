...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.NumberSearchReserveResponse();
  });
  ...
  describe('NumberSearchReserveResponse', function() {
    it('should create an instance of NumberSearchReserveResponse', function() {
      // uncomment below and update the code to test NumberSearchReserveResponse
      //var instane = new TfnrApIs.NumberSearchReserveResponse();
      //expect(instance).to.be.a(TfnrApIs.NumberSearchReserveResponse);
    });
