...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.NumberSearchResponse();
  });
  ...
  describe('NumberSearchResponse', function() {
    it('should create an instance of NumberSearchResponse', function() {
      // uncomment below and update the code to test NumberSearchResponse
      //var instane = new TfnrApIs.NumberSearchResponse();
      //expect(instance).to.be.a(TfnrApIs.NumberSearchResponse);
    });
    ...
    it('should have the property lastActDtList (base name: "lastActDtList")', function() {
      // uncomment below and update the code to test the property lastActDtList
      //var instane = new TfnrApIs.NumberSearchResponse();
      //expect(instance).to.be();
    });
