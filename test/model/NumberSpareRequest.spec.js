...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.NumberSpareRequest();
  });
  ...
  describe('NumberSpareRequest', function() {
    it('should create an instance of NumberSpareRequest', function() {
      // uncomment below and update the code to test NumberSpareRequest
      //var instane = new TfnrApIs.NumberSpareRequest();
      //expect(instance).to.be.a(TfnrApIs.NumberSpareRequest);
    });
