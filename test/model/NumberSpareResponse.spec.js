...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.NumberSpareResponse();
  });
  ...
  describe('NumberSpareResponse', function() {
    it('should create an instance of NumberSpareResponse', function() {
      // uncomment below and update the code to test NumberSpareResponse
      //var instane = new TfnrApIs.NumberSpareResponse();
      //expect(instance).to.be.a(TfnrApIs.NumberSpareResponse);
    });
