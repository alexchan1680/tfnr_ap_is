...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.NumberUpdateRequest();
  });
  ...
  describe('NumberUpdateRequest', function() {
    it('should create an instance of NumberUpdateRequest', function() {
      // uncomment below and update the code to test NumberUpdateRequest
      //var instane = new TfnrApIs.NumberUpdateRequest();
      //expect(instance).to.be.a(TfnrApIs.NumberUpdateRequest);
    });
