...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.NumberUpdateResponse();
  });
  ...
  describe('NumberUpdateResponse', function() {
    it('should create an instance of NumberUpdateResponse', function() {
      // uncomment below and update the code to test NumberUpdateResponse
      //var instane = new TfnrApIs.NumberUpdateResponse();
      //expect(instance).to.be.a(TfnrApIs.NumberUpdateResponse);
    });
