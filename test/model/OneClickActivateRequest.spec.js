...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.OneClickActivateRequest();
  });
  ...
  describe('OneClickActivateRequest', function() {
    it('should create an instance of OneClickActivateRequest', function() {
      // uncomment below and update the code to test OneClickActivateRequest
      //var instane = new TfnrApIs.OneClickActivateRequest();
      //expect(instance).to.be.a(TfnrApIs.OneClickActivateRequest);
    });
    ...
    it('should have the property conPhone (base name: "conPhone")', function() {
      // uncomment below and update the code to test the property conPhone
      //var instane = new TfnrApIs.OneClickActivateRequest();
      //expect(instance).to.be();
    });

    it('should have the property shrtNotes (base name: "shrtNotes")', function() {
      // uncomment below and update the code to test the property shrtNotes
      //var instane = new TfnrApIs.OneClickActivateRequest();
      //expect(instance).to.be();
    });

    it('should have the property numList (base name: "numList")', function() {
      // uncomment below and update the code to test the property numList
      //var instane = new TfnrApIs.OneClickActivateRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property cons (base name: "cons")', function() {
      // uncomment below and update the code to test the property cons
      //var instane = new TfnrApIs.OneClickActivateRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property numTermLine (base name: "numTermLine")', function() {
      // uncomment below and update the code to test the property numTermLine
      //var instane = new TfnrApIs.OneClickActivateRequest();
      //expect(instance).to.be();
    });
