...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.OneClickActivateResponse();
  });
  ...
  describe('OneClickActivateResponse', function() {
    it('should create an instance of OneClickActivateResponse', function() {
      // uncomment below and update the code to test OneClickActivateResponse
      //var instane = new TfnrApIs.OneClickActivateResponse();
      //expect(instance).to.be.a(TfnrApIs.OneClickActivateResponse);
    });
    ...
    it('should have the property blkResp (base name: "blkResp")', function() {
      // uncomment below and update the code to test the property blkResp
      //var instane = new TfnrApIs.OneClickActivateResponse();
      //expect(instance).to.be();
    });
