...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.PasswordForgetRequest();
  });
  ...
  describe('PasswordForgetRequest', function() {
    it('should create an instance of PasswordForgetRequest', function() {
      // uncomment below and update the code to test PasswordForgetRequest
      //var instane = new TfnrApIs.PasswordForgetRequest();
      //expect(instance).to.be.a(TfnrApIs.PasswordForgetRequest);
    });
