...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.PasswordForgetResponse();
  });
  ...
  describe('PasswordForgetResponse', function() {
    it('should create an instance of PasswordForgetResponse', function() {
      // uncomment below and update the code to test PasswordForgetResponse
      //var instane = new TfnrApIs.PasswordForgetResponse();
      //expect(instance).to.be.a(TfnrApIs.PasswordForgetResponse);
    });
