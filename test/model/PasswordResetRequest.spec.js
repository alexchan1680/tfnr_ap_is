...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.PasswordResetRequest();
  });
  ...
  describe('PasswordResetRequest', function() {
    it('should create an instance of PasswordResetRequest', function() {
      ...
      //var instane = new TfnrApIs.PasswordResetRequest();
      //expect(instance).to.be.a(TfnrApIs.PasswordResetRequest);
    });

    it('should have the property usrLoginId (base name: "usrLoginId")', function() {
      // uncomment below and update the code to test the property usrLoginId
      //var instane = new TfnrApIs.PasswordResetRequest();
