...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.PasswordResetResponse();
  });
  ...
  describe('PasswordResetResponse', function() {
    it('should create an instance of PasswordResetResponse', function() {
      // uncomment below and update the code to test PasswordResetResponse
      //var instane = new TfnrApIs.PasswordResetResponse();
      //expect(instance).to.be.a(TfnrApIs.PasswordResetResponse);
    });
