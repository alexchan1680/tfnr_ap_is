...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.PasswordUpdateResponse();
  });
  ...
  describe('PasswordUpdateResponse', function() {
    it('should create an instance of PasswordUpdateResponse', function() {
      // uncomment below and update the code to test PasswordUpdateResponse
      //var instane = new TfnrApIs.PasswordUpdateResponse();
      //expect(instance).to.be.a(TfnrApIs.PasswordUpdateResponse);
    });
