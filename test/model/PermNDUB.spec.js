...
(function(root, factory) {
  ...
  describe('PermNDUB', function() {
    it('should create an instance of PermNDUB', function() {
      // uncomment below and update the code to test PermNDUB
      //var instane = new TfnrApIs.PermNDUB();
      //expect(instance).to.be.a(TfnrApIs.PermNDUB);
    });
