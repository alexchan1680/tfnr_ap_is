...
(function(root, factory) {
  ...
  describe('PermNV', function() {
    it('should create an instance of PermNV', function() {
      // uncomment below and update the code to test PermNV
      //var instane = new TfnrApIs.PermNV();
      //expect(instance).to.be.a(TfnrApIs.PermNV);
    });
