...
(function(root, factory) {
  ...
  describe('PermNVDUB', function() {
    it('should create an instance of PermNVDUB', function() {
      // uncomment below and update the code to test PermNVDUB
      //var instane = new TfnrApIs.PermNVDUB();
      //expect(instance).to.be.a(TfnrApIs.PermNVDUB);
    });
