...
(function(root, factory) {
  ...
  describe('PermNVU', function() {
    it('should create an instance of PermNVU', function() {
      // uncomment below and update the code to test PermNVU
      //var instane = new TfnrApIs.PermNVU();
      //expect(instance).to.be.a(TfnrApIs.PermNVU);
    });
