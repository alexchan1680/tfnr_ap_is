...
(function(root, factory) {
  ...
  describe('PermNY', function() {
    it('should create an instance of PermNY', function() {
      // uncomment below and update the code to test PermNY
      //var instane = new TfnrApIs.PermNY();
      //expect(instance).to.be.a(TfnrApIs.PermNY);
    });
