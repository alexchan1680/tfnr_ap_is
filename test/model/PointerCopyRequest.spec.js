...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.PointerCopyRequest();
  });
  ...
  describe('PointerCopyRequest', function() {
    it('should create an instance of PointerCopyRequest', function() {
      // uncomment below and update the code to test PointerCopyRequest
      //var instane = new TfnrApIs.PointerCopyRequest();
      //expect(instance).to.be.a(TfnrApIs.PointerCopyRequest);
    });
