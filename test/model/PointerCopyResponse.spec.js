...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.PointerCopyResponse();
  });
  ...
  describe('PointerCopyResponse', function() {
    it('should create an instance of PointerCopyResponse', function() {
      // uncomment below and update the code to test PointerCopyResponse
      //var instane = new TfnrApIs.PointerCopyResponse();
      //expect(instance).to.be.a(TfnrApIs.PointerCopyResponse);
    });
