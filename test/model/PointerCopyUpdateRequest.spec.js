...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.PointerCopyUpdateRequest();
  });
  ...
  describe('PointerCopyUpdateRequest', function() {
    it('should create an instance of PointerCopyUpdateRequest', function() {
      // uncomment below and update the code to test PointerCopyUpdateRequest
      //var instane = new TfnrApIs.PointerCopyUpdateRequest();
      //expect(instance).to.be.a(TfnrApIs.PointerCopyUpdateRequest);
    });
