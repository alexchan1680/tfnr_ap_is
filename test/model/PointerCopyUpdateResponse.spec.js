...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.PointerCopyUpdateResponse();
  });
  ...
  describe('PointerCopyUpdateResponse', function() {
    it('should create an instance of PointerCopyUpdateResponse', function() {
      // uncomment below and update the code to test PointerCopyUpdateResponse
      //var instane = new TfnrApIs.PointerCopyUpdateResponse();
      //expect(instance).to.be.a(TfnrApIs.PointerCopyUpdateResponse);
    });
