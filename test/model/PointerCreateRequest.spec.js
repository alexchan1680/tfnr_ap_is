...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.PointerCreateRequest();
  });
  ...
  describe('PointerCreateRequest', function() {
    it('should create an instance of PointerCreateRequest', function() {
      // uncomment below and update the code to test PointerCreateRequest
      //var instane = new TfnrApIs.PointerCreateRequest();
      //expect(instance).to.be.a(TfnrApIs.PointerCreateRequest);
    });
