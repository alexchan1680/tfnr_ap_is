...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.PointerCreateResponse();
  });
  ...
  describe('PointerCreateResponse', function() {
    it('should create an instance of PointerCreateResponse', function() {
      // uncomment below and update the code to test PointerCreateResponse
      //var instane = new TfnrApIs.PointerCreateResponse();
      //expect(instance).to.be.a(TfnrApIs.PointerCreateResponse);
    });
