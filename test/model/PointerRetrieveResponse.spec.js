...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.PointerRetrieveResponse();
  });
  ...
  describe('PointerRetrieveResponse', function() {
    it('should create an instance of PointerRetrieveResponse', function() {
      // uncomment below and update the code to test PointerRetrieveResponse
      //var instane = new TfnrApIs.PointerRetrieveResponse();
      //expect(instance).to.be.a(TfnrApIs.PointerRetrieveResponse);
    });
    ...
    it('should have the property onAcctCust (base name: "onAcctCust")', function() {
      // uncomment below and update the code to test the property onAcctCust
      //var instane = new TfnrApIs.PointerRetrieveResponse();
      //expect(instance).to.be();
    });
