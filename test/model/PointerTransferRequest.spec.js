...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.PointerTransferRequest();
  });
  ...
  describe('PointerTransferRequest', function() {
    it('should create an instance of PointerTransferRequest', function() {
      // uncomment below and update the code to test PointerTransferRequest
      //var instane = new TfnrApIs.PointerTransferRequest();
      //expect(instance).to.be.a(TfnrApIs.PointerTransferRequest);
    });
