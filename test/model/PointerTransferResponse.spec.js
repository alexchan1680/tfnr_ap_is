...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.PointerTransferResponse();
  });
  ...
  describe('PointerTransferResponse', function() {
    it('should create an instance of PointerTransferResponse', function() {
      // uncomment below and update the code to test PointerTransferResponse
      //var instane = new TfnrApIs.PointerTransferResponse();
      //expect(instance).to.be.a(TfnrApIs.PointerTransferResponse);
    });

    it('should have the property controlRespOrg (base name: "controlRespOrg")', function() {
      // uncomment below and update the code to test the property controlRespOrg
      //var instane = new TfnrApIs.PointerTransferResponse();
