...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.PointerTransferUpdateRequest();
  });
  ...
  describe('PointerTransferUpdateRequest', function() {
    it('should create an instance of PointerTransferUpdateRequest', function() {
      // uncomment below and update the code to test PointerTransferUpdateRequest
      //var instane = new TfnrApIs.PointerTransferUpdateRequest();
      //expect(instance).to.be.a(TfnrApIs.PointerTransferUpdateRequest);
    });
