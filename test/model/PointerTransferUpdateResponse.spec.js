...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.PointerTransferUpdateResponse();
  });
  ...
  describe('PointerTransferUpdateResponse', function() {
    it('should create an instance of PointerTransferUpdateResponse', function() {
      // uncomment below and update the code to test PointerTransferUpdateResponse
      //var instane = new TfnrApIs.PointerTransferUpdateResponse();
      //expect(instance).to.be.a(TfnrApIs.PointerTransferUpdateResponse);
    });
    ...
    it('should have the property custRecStat (base name: "custRecStat")', function() {
      // uncomment below and update the code to test the property custRecStat
      //var instane = new TfnrApIs.PointerTransferUpdateResponse();
      //expect(instance).to.be();
    });
