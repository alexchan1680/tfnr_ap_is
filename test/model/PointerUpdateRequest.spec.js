...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.PointerUpdateRequest();
  });
  ...
  describe('PointerUpdateRequest', function() {
    it('should create an instance of PointerUpdateRequest', function() {
      // uncomment below and update the code to test PointerUpdateRequest
      //var instane = new TfnrApIs.PointerUpdateRequest();
      //expect(instance).to.be.a(TfnrApIs.PointerUpdateRequest);
    });
