...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.PointerUpdateResponse();
  });
  ...
  describe('PointerUpdateResponse', function() {
    it('should create an instance of PointerUpdateResponse', function() {
      // uncomment below and update the code to test PointerUpdateResponse
      //var instane = new TfnrApIs.PointerUpdateResponse();
      //expect(instance).to.be.a(TfnrApIs.PointerUpdateResponse);
    });
