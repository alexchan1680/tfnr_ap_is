...
(function(root, factory) {
  ...
  describe('RecStat', function() {
    it('should create an instance of RecStat', function() {
      // uncomment below and update the code to test RecStat
      //var instane = new TfnrApIs.RecStat();
      //expect(instance).to.be.a(TfnrApIs.RecStat);
    });
