...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.RecordCopyRequest();
  });
  ...
  describe('RecordCopyRequest', function() {
    it('should create an instance of RecordCopyRequest', function() {
      // uncomment below and update the code to test RecordCopyRequest
      //var instane = new TfnrApIs.RecordCopyRequest();
      //expect(instance).to.be.a(TfnrApIs.RecordCopyRequest);
    });
