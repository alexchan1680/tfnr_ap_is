...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.RecordCopyResponse();
  });
  ...
  describe('RecordCopyResponse', function() {
    it('should create an instance of RecordCopyResponse', function() {
      // uncomment below and update the code to test RecordCopyResponse
      //var instane = new TfnrApIs.RecordCopyResponse();
      //expect(instance).to.be.a(TfnrApIs.RecordCopyResponse);
    });
