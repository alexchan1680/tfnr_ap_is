...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.RecordCopyUpdateRequest();
  });
  ...
  describe('RecordCopyUpdateRequest', function() {
    it('should create an instance of RecordCopyUpdateRequest', function() {
      // uncomment below and update the code to test RecordCopyUpdateRequest
      //var instane = new TfnrApIs.RecordCopyUpdateRequest();
      //expect(instance).to.be.a(TfnrApIs.RecordCopyUpdateRequest);
    });
