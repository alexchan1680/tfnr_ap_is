...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.RecordCopyUpdateResponse();
  });
  ...
  describe('RecordCopyUpdateResponse', function() {
    it('should create an instance of RecordCopyUpdateResponse', function() {
      // uncomment below and update the code to test RecordCopyUpdateResponse
      //var instane = new TfnrApIs.RecordCopyUpdateResponse();
      //expect(instance).to.be.a(TfnrApIs.RecordCopyUpdateResponse);
    });
