...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.RecordCreateRequest();
  });
  ...
  describe('RecordCreateRequest', function() {
    it('should create an instance of RecordCreateRequest', function() {
      // uncomment below and update the code to test RecordCreateRequest
      //var instane = new TfnrApIs.RecordCreateRequest();
      //expect(instance).to.be.a(TfnrApIs.RecordCreateRequest);
    });
