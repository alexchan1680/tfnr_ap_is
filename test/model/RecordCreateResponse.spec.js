...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.RecordCreateResponse();
  });
  ...
  describe('RecordCreateResponse', function() {
    it('should create an instance of RecordCreateResponse', function() {
      // uncomment below and update the code to test RecordCreateResponse
      //var instane = new TfnrApIs.RecordCreateResponse();
      //expect(instance).to.be.a(TfnrApIs.RecordCreateResponse);
    });
