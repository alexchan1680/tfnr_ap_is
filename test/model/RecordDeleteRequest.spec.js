...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.RecordDeleteRequest();
  });
  ...
  describe('RecordDeleteRequest', function() {
    it('should create an instance of RecordDeleteRequest', function() {
      // uncomment below and update the code to test RecordDeleteRequest
      //var instane = new TfnrApIs.RecordDeleteRequest();
      //expect(instance).to.be.a(TfnrApIs.RecordDeleteRequest);
    });
