...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.RecordDeleteResponse();
  });
  ...
  describe('RecordDeleteResponse', function() {
    it('should create an instance of RecordDeleteResponse', function() {
      // uncomment below and update the code to test RecordDeleteResponse
      //var instane = new TfnrApIs.RecordDeleteResponse();
      //expect(instance).to.be.a(TfnrApIs.RecordDeleteResponse);
    });
