...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.RecordDisconnectUpdateRequest();
  });
  ...
  describe('RecordDisconnectUpdateRequest', function() {
    it('should create an instance of RecordDisconnectUpdateRequest', function() {
      // uncomment below and update the code to test RecordDisconnectUpdateRequest
      //var instane = new TfnrApIs.RecordDisconnectUpdateRequest();
      //expect(instance).to.be.a(TfnrApIs.RecordDisconnectUpdateRequest);
    });
