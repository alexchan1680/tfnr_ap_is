...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.RecordDisconnectUpdateResponse();
  });
  ...
  describe('RecordDisconnectUpdateResponse', function() {
    it('should create an instance of RecordDisconnectUpdateResponse', function() {
      // uncomment below and update the code to test RecordDisconnectUpdateResponse
      //var instane = new TfnrApIs.RecordDisconnectUpdateResponse();
      //expect(instance).to.be.a(TfnrApIs.RecordDisconnectUpdateResponse);
    });
