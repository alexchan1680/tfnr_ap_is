...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.RecordRetrieveResponse();
  });
  ...
  describe('RecordRetrieveResponse', function() {
    it('should create an instance of RecordRetrieveResponse', function() {
      // uncomment below and update the code to test RecordRetrieveResponse
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be.a(TfnrApIs.RecordRetrieveResponse);
    });

    it('should have the property ctrlRespOrgId (base name: "ctrlRespOrgId")', function() {
      // uncomment below and update the code to test the property ctrlRespOrgId
      //var instane = new TfnrApIs.RecordRetrieveResponse();
    ...
    it('should have the property numStatus (base name: "numStatus")', function() {
      // uncomment below and update the code to test the property numStatus
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });

    it('should have the property effDtTm (base name: "effDtTm")', function() {
      // uncomment below and update the code to test the property effDtTm
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });

    it('should have the property lstEffDtTms (base name: "lstEffDtTms")', function() {
      // uncomment below and update the code to test the property lstEffDtTms
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property prevUsr (base name: "prevUsr")', function() {
      // uncomment below and update the code to test the property prevUsr
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });

    it('should have the property lastUpDt (base name: "lastUpDt")', function() {
      // uncomment below and update the code to test the property lastUpDt
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });

    it('should have the property lastUsr (base name: "lastUsr")', function() {
      // uncomment below and update the code to test the property lastUsr
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });

    it('should have the property interLATACarrier (base name: "interLATACarrier")', function() {
      // uncomment below and update the code to test the property interLATACarrier
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });

    it('should have the property intraLATACarrier (base name: "intraLATACarrier")', function() {
      // uncomment below and update the code to test the property intraLATACarrier
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });

    it('should have the property dueDt (base name: "dueDt")', function() {
      // uncomment below and update the code to test the property dueDt
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });

    it('should have the property hldIndFlag (base name: "hldIndFlag")', function() {
      // uncomment below and update the code to test the property hldIndFlag
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });

    it('should have the property svcOrderNum (base name: "svcOrderNum")', function() {
      // uncomment below and update the code to test the property svcOrderNum
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });

    it('should have the property suppFormNum (base name: "suppFormNum")', function() {
      // uncomment below and update the code to test the property suppFormNum
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property onAccCust (base name: "onAccCust")', function() {
      // uncomment below and update the code to test the property onAccCust
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });

    it('should have the property endSubAddr (base name: "endSubAddr")', function() {
      // uncomment below and update the code to test the property endSubAddr
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });

    it('should have the property conName (base name: "conName")', function() {
      // uncomment below and update the code to test the property conName
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });

    it('should have the property conTel (base name: "conTel")', function() {
      // uncomment below and update the code to test the property conTel
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property endSub (base name: "endSub")', function() {
      // uncomment below and update the code to test the property endSub
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });

    it('should have the property destNums (base name: "destNums")', function() {
      // uncomment below and update the code to test the property destNums
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });

    it('should have the property cprSectName (base name: "cprSectName")', function() {
      // uncomment below and update the code to test the property cprSectName
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });

    it('should have the property priInterLT (base name: "priInterLT")', function() {
      // uncomment below and update the code to test the property priInterLT
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });

    it('should have the property priIntraLT (base name: "priIntraLT")', function() {
      // uncomment below and update the code to test the property priIntraLT
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property endInterceptDt (base name: "endInterceptDt")', function() {
      // uncomment below and update the code to test the property endInterceptDt
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });

    it('should have the property tmZn (base name: "tmZn")', function() {
      // uncomment below and update the code to test the property tmZn
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property reqEffDtTm (base name: "reqEffDtTm")', function() {
      // uncomment below and update the code to test the property reqEffDtTm
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });

    it('should have the property errList (base name: "errList")', function() {
      // uncomment below and update the code to test the property errList
      //var instane = new TfnrApIs.RecordRetrieveResponse();
      //expect(instance).to.be();
    });
