...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.RecordTransferRequest();
  });
  ...
  describe('RecordTransferRequest', function() {
    it('should create an instance of RecordTransferRequest', function() {
      // uncomment below and update the code to test RecordTransferRequest
      //var instane = new TfnrApIs.RecordTransferRequest();
      //expect(instance).to.be.a(TfnrApIs.RecordTransferRequest);
    });
