...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.RecordTransferUpdateRequest();
  });
  ...
  describe('RecordTransferUpdateRequest', function() {
    it('should create an instance of RecordTransferUpdateRequest', function() {
      // uncomment below and update the code to test RecordTransferUpdateRequest
      //var instane = new TfnrApIs.RecordTransferUpdateRequest();
      //expect(instance).to.be.a(TfnrApIs.RecordTransferUpdateRequest);
    });
    ...
    it('should have the property tgtNum (base name: "tgtNum")', function() {
      // uncomment below and update the code to test the property tgtNum
      //var instane = new TfnrApIs.RecordTransferUpdateRequest();
      //expect(instance).to.be();
    });

    it('should have the property srcEffDtTm (base name: "srcEffDtTm")', function() {
      // uncomment below and update the code to test the property srcEffDtTm
      //var instane = new TfnrApIs.RecordTransferUpdateRequest();
      //expect(instance).to.be();
    });

    it('should have the property reqSntFrom (base name: "reqSntFrom")', function() {
      // uncomment below and update the code to test the property reqSntFrom
      //var instane = new TfnrApIs.RecordTransferUpdateRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property interLTCar (base name: "interLTCar")', function() {
      // uncomment below and update the code to test the property interLTCar
      //var instane = new TfnrApIs.RecordTransferUpdateRequest();
      //expect(instance).to.be();
    });

    it('should have the property intraLTCar (base name: "intraLTCar")', function() {
      // uncomment below and update the code to test the property intraLTCar
      //var instane = new TfnrApIs.RecordTransferUpdateRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property newRespOrgId (base name: "newRespOrgId")', function() {
      // uncomment below and update the code to test the property newRespOrgId
      //var instane = new TfnrApIs.RecordTransferUpdateRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property numRoutPath (base name: "numRoutPath")', function() {
      // uncomment below and update the code to test the property numRoutPath
      //var instane = new TfnrApIs.RecordTransferUpdateRequest();
      //expect(instance).to.be();
    });

    it('should have the property custRecCompPart (base name: "custRecCompPart")', function() {
      // uncomment below and update the code to test the property custRecCompPart
      //var instane = new TfnrApIs.RecordTransferUpdateRequest();
      //expect(instance).to.be();
    });
