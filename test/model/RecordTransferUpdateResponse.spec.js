...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.RecordTransferUpdateResponse();
  });
  ...
  describe('RecordTransferUpdateResponse', function() {
    it('should create an instance of RecordTransferUpdateResponse', function() {
      // uncomment below and update the code to test RecordTransferUpdateResponse
      //var instane = new TfnrApIs.RecordTransferUpdateResponse();
      //expect(instance).to.be.a(TfnrApIs.RecordTransferUpdateResponse);
    });
