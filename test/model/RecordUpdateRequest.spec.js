...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.RecordUpdateRequest();
  });
  ...
  describe('RecordUpdateRequest', function() {
    it('should create an instance of RecordUpdateRequest', function() {
      // uncomment below and update the code to test RecordUpdateRequest
      //var instane = new TfnrApIs.RecordUpdateRequest();
      //expect(instance).to.be.a(TfnrApIs.RecordUpdateRequest);
    });
