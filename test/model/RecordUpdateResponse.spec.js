...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.RecordUpdateResponse();
  });
  ...
  describe('RecordUpdateResponse', function() {
    it('should create an instance of RecordUpdateResponse', function() {
      // uncomment below and update the code to test RecordUpdateResponse
      //var instane = new TfnrApIs.RecordUpdateResponse();
      //expect(instance).to.be.a(TfnrApIs.RecordUpdateResponse);
    });
