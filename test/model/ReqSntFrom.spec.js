...
(function(root, factory) {
  ...
  describe('ReqSntFrom', function() {
    it('should create an instance of ReqSntFrom', function() {
      // uncomment below and update the code to test ReqSntFrom
      //var instane = new TfnrApIs.ReqSntFrom();
      //expect(instance).to.be.a(TfnrApIs.ReqSntFrom);
    });
