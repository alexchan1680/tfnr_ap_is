...
(function(root, factory) {
  ...
  describe('ReqStatus', function() {
    it('should create an instance of ReqStatus', function() {
      // uncomment below and update the code to test ReqStatus
      //var instane = new TfnrApIs.ReqStatus();
      //expect(instance).to.be.a(TfnrApIs.ReqStatus);
    });
