...
(function(root, factory) {
  ...
  describe('ReqType', function() {
    it('should create an instance of ReqType', function() {
      // uncomment below and update the code to test ReqType
      //var instane = new TfnrApIs.ReqType();
      //expect(instance).to.be.a(TfnrApIs.ReqType);
    });
