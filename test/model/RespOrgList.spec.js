...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.RespOrgList();
  });
  ...
  describe('RespOrgList', function() {
    it('should create an instance of RespOrgList', function() {
      // uncomment below and update the code to test RespOrgList
      //var instane = new TfnrApIs.RespOrgList();
      //expect(instance).to.be.a(TfnrApIs.RespOrgList);
    });

    it('should have the property respOrgList (base name: "respOrgList")', function() {
      // uncomment below and update the code to test the property respOrgList
      //var instane = new TfnrApIs.RespOrgList();
