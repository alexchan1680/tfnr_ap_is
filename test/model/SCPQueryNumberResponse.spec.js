...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.SCPQueryNumberResponse();
  });
  ...
  describe('SCPQueryNumberResponse', function() {
    it('should create an instance of SCPQueryNumberResponse', function() {
      // uncomment below and update the code to test SCPQueryNumberResponse
      //var instane = new TfnrApIs.SCPQueryNumberResponse();
      //expect(instance).to.be.a(TfnrApIs.SCPQueryNumberResponse);
    });
