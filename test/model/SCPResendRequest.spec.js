...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.SCPResendRequest();
  });
  ...
  describe('SCPResendRequest', function() {
    it('should create an instance of SCPResendRequest', function() {
      // uncomment below and update the code to test SCPResendRequest
      //var instane = new TfnrApIs.SCPResendRequest();
      //expect(instance).to.be.a(TfnrApIs.SCPResendRequest);
    });
