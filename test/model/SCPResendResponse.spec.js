...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.SCPResendResponse();
  });
  ...
  describe('SCPResendResponse', function() {
    it('should create an instance of SCPResendResponse', function() {
      // uncomment below and update the code to test SCPResendResponse
      //var instane = new TfnrApIs.SCPResendResponse();
      //expect(instance).to.be.a(TfnrApIs.SCPResendResponse);
    });
