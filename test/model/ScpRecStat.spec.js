...
(function(root, factory) {
  ...
  describe('ScpRecStat', function() {
    it('should create an instance of ScpRecStat', function() {
      // uncomment below and update the code to test ScpRecStat
      //var instane = new TfnrApIs.ScpRecStat();
      //expect(instance).to.be.a(TfnrApIs.ScpRecStat);
    });
