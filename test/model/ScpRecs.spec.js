...
(function(root, factory) {
  ...
  describe('ScpRecs', function() {
    it('should create an instance of ScpRecs', function() {
      // uncomment below and update the code to test ScpRecs
      //var instane = new TfnrApIs.ScpRecs();
      //expect(instance).to.be.a(TfnrApIs.ScpRecs);
    });
