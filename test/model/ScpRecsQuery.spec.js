...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.ScpRecsQuery();
  });
  ...
  describe('ScpRecsQuery', function() {
    it('should create an instance of ScpRecsQuery', function() {
      // uncomment below and update the code to test ScpRecsQuery
      //var instane = new TfnrApIs.ScpRecsQuery();
      //expect(instance).to.be.a(TfnrApIs.ScpRecsQuery);
    });

    it('should have the property scpId (base name: "scpId")', function() {
      // uncomment below and update the code to test the property scpId
      //var instane = new TfnrApIs.ScpRecsQuery();
      //expect(instance).to.be();
    });

    it('should have the property scpRecStat (base name: "scpRecStat")', function() {
      // uncomment below and update the code to test the property scpRecStat
      //var instane = new TfnrApIs.ScpRecsQuery();
      //expect(instance).to.be();
    });

    it('should have the property inAOS (base name: "inAOS")', function() {
      // uncomment below and update the code to test the property inAOS
      //var instane = new TfnrApIs.ScpRecsQuery();
      //expect(instance).to.be();
    });
