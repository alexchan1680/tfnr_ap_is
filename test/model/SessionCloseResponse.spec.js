...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.SessionCloseResponse();
  });
  ...
  describe('SessionCloseResponse', function() {
    it('should create an instance of SessionCloseResponse', function() {
      // uncomment below and update the code to test SessionCloseResponse
      //var instane = new TfnrApIs.SessionCloseResponse();
      //expect(instance).to.be.a(TfnrApIs.SessionCloseResponse);
    });
