...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.SessionOpenRequest();
  });
  ...
  describe('SessionOpenRequest', function() {
    it('should create an instance of SessionOpenRequest', function() {
      // uncomment below and update the code to test SessionOpenRequest
      //var instane = new TfnrApIs.SessionOpenRequest();
      //expect(instance).to.be.a(TfnrApIs.SessionOpenRequest);
    });
    ...
    it('should have the property withPerm (base name: "withPerm")', function() {
      // uncomment below and update the code to test the property withPerm
      //var instane = new TfnrApIs.SessionOpenRequest();
      //expect(instance).to.be();
    });
