...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.SessionOpenResponse();
  });
  ...
  describe('SessionOpenResponse', function() {
    it('should create an instance of SessionOpenResponse', function() {
      // uncomment below and update the code to test SessionOpenResponse
      //var instane = new TfnrApIs.SessionOpenResponse();
      //expect(instance).to.be.a(TfnrApIs.SessionOpenResponse);
    });
    ...
    it('should have the property permRecord (base name: "permRecord")', function() {
      // uncomment below and update the code to test the property permRecord
      //var instane = new TfnrApIs.SessionOpenResponse();
      //expect(instance).to.be();
    });
