...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.TRQResult();
  });
  ...
  describe('TRQResult', function() {
    it('should create an instance of TRQResult', function() {
      // uncomment below and update the code to test TRQResult
      //var instane = new TfnrApIs.TRQResult();
      //expect(instance).to.be.a(TfnrApIs.TRQResult);
    });

    it('should have the property dialNum (base name: "dialNum")', function() {
      // uncomment below and update the code to test the property dialNum
      //var instane = new TfnrApIs.TRQResult();
      //expect(instance).to.be();
    });

    it('should have the property respOrgQueried (base name: "respOrgQueried")', function() {
      // uncomment below and update the code to test the property respOrgQueried
      //var instane = new TfnrApIs.TRQResult();
      //expect(instance).to.be();
    });

    it('should have the property respOrgName (base name: "respOrgName")', function() {
      // uncomment below and update the code to test the property respOrgName
      //var instane = new TfnrApIs.TRQResult();
      //expect(instance).to.be();
    });

    it('should have the property troubleReqNum (base name: "troubleReqNum")', function() {
      // uncomment below and update the code to test the property troubleReqNum
      //var instane = new TfnrApIs.TRQResult();
      //expect(instance).to.be();
    });
