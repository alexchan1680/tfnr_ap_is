...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.TempList();
  });
  ...
  describe('TempList', function() {
    it('should create an instance of TempList', function() {
      // uncomment below and update the code to test TempList
      //var instane = new TfnrApIs.TempList();
      //expect(instance).to.be.a(TfnrApIs.TempList);
    });
    ...
    it('should have the property descrip (base name: "descrip")', function() {
      // uncomment below and update the code to test the property descrip
      //var instane = new TfnrApIs.TempList();
      //expect(instance).to.be();
    });
