...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.TemplateListResponse();
  });
  ...
  describe('TemplateListResponse', function() {
    it('should create an instance of TemplateListResponse', function() {
      ...
      //var instane = new TfnrApIs.TemplateListResponse();
      //expect(instance).to.be.a(TfnrApIs.TemplateListResponse);
    });

    it('should have the property tempEntRecId (base name: "tempEntRecId")', function() {
      // uncomment below and update the code to test the property tempEntRecId
      //var instane = new TfnrApIs.TemplateListResponse();
      //expect(instance).to.be();
    });

    it('should have the property startTempName (base name: "startTempName")', function() {
      // uncomment below and update the code to test the property startTempName
      //var instane = new TfnrApIs.TemplateListResponse();
      //expect(instance).to.be();
    });

    it('should have the property tempList (base name: "tempList")', function() {
      // uncomment below and update the code to test the property tempList
      //var instane = new TfnrApIs.TemplateListResponse();
      //expect(instance).to.be();
    });
