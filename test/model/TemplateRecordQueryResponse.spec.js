...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.TemplateRecordQueryResponse();
  });
  ...
  describe('TemplateRecordQueryResponse', function() {
    it('should create an instance of TemplateRecordQueryResponse', function() {
      // uncomment below and update the code to test TemplateRecordQueryResponse
      //var instane = new TfnrApIs.TemplateRecordQueryResponse();
      //expect(instance).to.be.a(TfnrApIs.TemplateRecordQueryResponse);
    });

    it('should have the property ctlRespOrgId (base name: "ctlRespOrgId")', function() {
      // uncomment below and update the code to test the property ctlRespOrgId
      //var instane = new TfnrApIs.TemplateRecordQueryResponse();
      //expect(instance).to.be();
    });

    it('should have the property custRecPerms (base name: "custRecPerms")', function() {
      // uncomment below and update the code to test the property custRecPerms
      //var instane = new TfnrApIs.TemplateRecordQueryResponse();
      //expect(instance).to.be();
    });

    it('should have the property effDtTmList (base name: "effDtTmList")', function() {
      // uncomment below and update the code to test the property effDtTmList
      //var instane = new TfnrApIs.TemplateRecordQueryResponse();
      //expect(instance).to.be();
    });
