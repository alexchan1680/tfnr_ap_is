...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.TimeoutResponse();
  });
  ...
  describe('TimeoutResponse', function() {
    it('should create an instance of TimeoutResponse', function() {
      // uncomment below and update the code to test TimeoutResponse
      //var instane = new TfnrApIs.TimeoutResponse();
      //expect(instance).to.be.a(TfnrApIs.TimeoutResponse);
    });
