...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TfnrApIs.TroubleNumberQueryResponse();
  });
  ...
  describe('TroubleNumberQueryResponse', function() {
    it('should create an instance of TroubleNumberQueryResponse', function() {
      // uncomment below and update the code to test TroubleNumberQueryResponse
      //var instane = new TfnrApIs.TroubleNumberQueryResponse();
      //expect(instance).to.be.a(TfnrApIs.TroubleNumberQueryResponse);
    });

    it('should have the property tRQResult (base name: "TRQResult")', function() {
      // uncomment below and update the code to test the property tRQResult
      //var instane = new TfnrApIs.TroubleNumberQueryResponse();
